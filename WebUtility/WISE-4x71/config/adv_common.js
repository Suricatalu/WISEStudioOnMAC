...
var URL_RF_CONFIG = URL_BASE + "rf_config";
var URL_RF_VALUE = URL_BASE + "rf_value";
var URL_CELLULAR_CONFIG = URL_BASE + "cell_config";
var URL_CELLULAR_ADV_CONFIG = URL_BASE + "cell_advanconfig";
var URL_CELLULAR_VALUE = URL_BASE + "cell_value";
var URL_SMS_CONFIG = URL_BASE + "sms_config";
...
var URL_LOG_DATA_OPTION = URL_BASE + "log_dataoption/slot_0";
var URL_LOGSYS_DATA_OPTION = URL_BASE + "logsys_dataoption/slot_0";
var URL_LOG_DATA_CONTROL = URL_BASE + "log_control/slot_0";
//var URL_LOG_DATA_PUSH = URL_BASE + "push_config";
var URL_LOG_DATA_OUTPUT = URL_BASE + "log_output/slot_0";
var URL_LOGSYS_DATA_OUTPUT = URL_BASE + "logsys_output/slot_0";
var URL_LOG_DATA_MESSAGE = URL_BASE + "log_message/slot_0";
var URL_LOGSYS_DATA_MESSAGE = URL_BASE + "logsys_message/slot_0";
var URL_LOG_PUSH_OUTPUT = URL_BASE + "push_output/slot_0";
var URL_GENERAL_CONFIG = URL_BASE + "gen_config";
var URL_LOG_DATA_EVENT = URL_BASE + "log_event/slot_0";
var URL_LOG_LOG_SWITCH = URL_BASE + "log_switch/slot_0";
...
var URL_MODBUS_SLAVE_GEN_CONFIG = URL_BASE + "modbusslave_genconfig";
var URL_MODBUS_SLAVE_CONFIG = URL_BASE + "modbusslave_config";
var URL_MODBUS_SLAVE_STATUS = URL_BASE + "modbusslave_status";
var URL_MODBUS_SERVER_GEN_CONFIG = URL_BASE + "modbusserver_genconfig";
var URL_MODBUS_SERVER_CONFIG = URL_BASE + "modbusserver_config";
var URL_MODBUS_SERVER_STATUS = URL_BASE + "modbusserver_status";
var URL_MODBUS_GEN_CONFIG = URL_MODBUS_SERVER_GEN_CONFIG ;
var URL_MODBUS_CONFIG = URL_MODBUS_SERVER_CONFIG;
var URL_MODBUS_STATUS = URL_MODBUS_SERVER_STATUS;
...
var URL_NODE_LIST = URL_BASE + "nodelist";
var URL_WACLOUD_AI_CONFIG = URL_BASE + "wacloud_ai";
var URL_WACLOUD_DI_CONFIG = URL_BASE + "wacloud_di";
var URL_WACLOUD_DO_CONFIG = URL_BASE + "wacloud_do";
var URL_WACLOUD_BIT_CONFIG = URL_BASE + "wacloud_expansion_bit";
var URL_WACLOUD_WORD_CONFIG = URL_BASE + "wacloud_expansion_word";
var URL_POSITION_VALUE = URL_BASE + "position_value";
var URL_POSITION_CONFIG = URL_BASE + "position_config";
var URL_MQTT_CONFIG = URL_BASE + "isensingmqtt_config";
var URL_AZURE_CONFIG = URL_BASE + "azure_config";
var URL_GENERAL_STATUS = URL_BASE + "gen_status";
var URL_CH_TELCOM_CONFIG = URL_BASE + "chinatelecom_config";
var URL_WISE_PAAS20_CONFIG = URL_BASE + "wpcloud_config";
var URL_WISEPAAS_AI_CONFIG = URL_BASE + "wpcloud_ai";
var URL_WISEPAAS_DI_CONFIG = URL_BASE + "wpcloud_di";
var URL_WISEPAAS_DO_CONFIG = URL_BASE + "wpcloud_do";
var URL_WISEPAAS_BIT_CONFIG = URL_BASE + "wpcloud_expansion_bit";
var URL_WISEPAAS_WORD_CONFIG = URL_BASE + "wpcloud_expansion_word";
var URL_TSYSTEM_CONFIG = URL_BASE + "TSystems_config";
var URL_SITE_SURVEY_CONFIG = URL_BASE + "cell_siteconfig";
var URL_SITE_SURVEY_STATUS = URL_BASE + "cell_sitestatus";
var URL_MQTT_FILE = URL_BASE + "mqtt_file.cfg";
...
$.extend(true, Advantech, {
    Profile: {
        ...
        RTDRangeEmun:{
            "937":"PT100(385) -200~ +600°C",
            "969":"PT100(392) -200~ +600°C",
            "994":"PT1000 -40~ +160°C",
            "65535":"****"
        },
        AIRangeInfoEmun:{
            ...
            "937":{min:-200, max:600, unit:"°C", zero:"20 ohm", span:"300 ohm"},
            "969":{min:-200, max:600, unit:"°C", zero:"20 ohm", span:"300 ohm"},
            "994":{min:-40, max:160, unit:"°C", zero:"500 ohm", span:"1600 ohm"},
            "65535":{min:"****", max:"****", unit:"****"}
        },
        AISamplingSpeedEmun:{
            "0": "10 Hz/Ch",
        ...
        DataLogIOTypeEmun: [
            ...
            "DI period (counter mode)",
            "DI low-to-high trigger tick",
            "Invalid",
            "Invalid",
            "Invalid",
            "Invalid",
        ...
        CloudServiceVenderEmun: {
            ...
            "LwM2M":1024,
            "TSystem":2048,
            "ChungHwaTelecomIoT":4096,
            "AWS":8192,
            "AzureMQTT":16384
        },
        CloudDropBoxTokenEmun: {
            0: "Token not ready",
            1: "Token ready"
        },
        CloudConnectStatusEmun: {
            0: "Invalid or Idle",
            1: "Connected",
            2: "Connecting",
            3: "Stopped"
        ...
        CloudErrorCodeEmun: {
            ...
            2:  "DNS query was failed",
            3:  "Connection to host was failed",
            4:  "Disconnect from server abnormally",
            5:  "Send header to server failed",
            6:  "Send data to server failed",
            7:  "Fail to receive response from the server",
            10:  "Other HTTP/CoAP error code",
            11:  "HTTP/CoAP 400 Bad request",
            12:  "HTTP/CoAP 401 Unauthorized",
            13:  "HTTP/CoAP 403 Forbidden",
            14:  "HTTP/CoAP 404 Not found",
            15:  "HTTP/CoAP 409 Conflict",
            16:  "HTTP/CoAP 429 Too many request",
            17:  "HTTP/CoAP 500 Internal error",
            18:  "HTTP/CoAP 503 Service unavailable",
            19:  "HTTP/CoAP 507 Insufficient storage",
            20:  "HTTP/CoAP 402 Bad option",
            21:  "HTTP/CoAP 405 Method not allowed",
            22:  "HTTP/CoAP 406 Not acceptable",
            23:  "HTTP/CoAP 408 Req entity incomplete",
            24:  "HTTP/CoAP 412 Precondition failed",
            25:  "HTTP/CoAP 413 Entity too large",
            26:  "HTTP/CoAP 501 Not implemented",
            //DropBox
            30:  "Bad input parameter for Dropbox",
            31:  "Bad or expired token for Dropbox",
            32:  "Bad OAuth request (wrong consumer key, bad nonce, expired timestamp...)",
            33:  "Your app is making too many requests for Dropbox",
            34:  "Transient server error for Dropbox",
            35:  "User is over Dropbox storage quota",
            //Aliyun
            50:  "Faile to receive response from the server of Aliyun OSS",
            51:  "Access the server of Aliyun OSS was denied",
            52:  "Access ID was invalid for Aliyun OSS",
            53:  "Bucket name was invalid for Aliyun OSS",
            54:  "Internal server of Aliyun OSS error",
            55:  "Bucket was not existed on the server of Aliyun OSS",
            56:  "Request time too skewed to the server of Aliyun OSS",
            57:  "Request to the server of Aliyun OSS was time-out",
            58:  "Access Key does not match",
            59:  "The file already existed on the server of Aliyun OSS",
            //Azure
            70:  "Upload file already exists",
            71:  "Incorrect received storage account information",
            72:  "Invalid IOT Hub authorization",
            73:  "Excessive request to upload",
            74:  "Azure storage connection fail",
            75:  "Invalid Azure storage authorization",
            76:  "Invalid request URL to Azure storage",
            77:  "Unregistered device on Azure",
            //WebAccess
            90:  "WebSocket connection was unexpectedly aborted",
            91:  "Receive WebSocket disconnection unexpectedly",
            92:  "Fail to establish the WebSocket connection",
            93:  "Fail to send the MQTT CONNECT",
            94:  "Fail to transmit the MQTT SUBSCRIBE",
            95:  "Fail to PUBLISH the connection status",
            96:  "Fail to PUBLISH the configuration information",
            97:  "Fail to PUBLISH the data value",
            98:  "MQTT PUBACK was not received",
            99:  "Internal buffer error",
            101: "MQTT connection refused, unacceptable protocol version",
            102: "MQTT connection refused, identifier rejected",
            103: "MQTT connection refused, Server unavailable",
            104: "MQTT connection refused, bad user name or password",
            105: "MQTT connection refused, not authorized",
            106: "Fail to allocate memory",
            //IFTTT
            120: "Invalid Webhooks IFTTT key",
            //China Telecom
            140: "Fail to register to server",
            141: "Fail to get server request",
            142: "Reserved",
            //CoAP
            160: "COAP 4XX ERRORS",
            161: "COAP 5XX ERRORS",
            162: "COAP 400 BAD REQUEST",
            163: "COAP 401 UNAUTHORIZED",
            164: "COAP 402 BAD OPTION",
            165: "COAP 403 FORBIDDEN",
            166: "COAP 404 NOT FOUND",
            167: "COAP 405 METHOD NOT ALLOWED",
            168: "COAP 406 NOT ACCEPTABLE",
            169: "COAP 408 REQ ENTITY INCOMPLETE",
            170: "COAP 409 CONFLICT",
            171: "COAP 412 PRECONDITION FAILED",
            172: "COAP 413 ENTITY TOO LARGE",
            173: "COAP 500 INTERNAL SERVER ERROR",
            174: "COAP 501 NOT IMPLEMENTED",
            175: "COAP 503 SERVICE UNAVAILABLE",
            //T-System
            180: "Fail to send the MQTT-SN CONNECT",
            181: "MQTT-SN CONNACK was not received",
            182: "Fail to send the MQTT-SN SUBSCRIBE",
            183: "MQTT-SN SUBACKwas not received",
            184: "Fail to send the MQTT-SN REGISTER",
            185: "MQTT-SN REGACKwas not received",
            186: "Fail to PUBLISH the data value",
            187: "MQTT-SN PUBACKwas not received",
            188: "MQTT-SN PINGRESP was not received",
            189: "MQTT-SN Rejected: congestion",
            190: "MQTT-SN Rejected: invalid topic ID",
            191: "MQTT-SN Rejected: not supported"
        },
        ...
        DataLoggerSystemEventEmun: {
            "CELLULAR_INFO" : 0,
            "CELLULAR_CME_ERROR" : 1,
            "COMMUNICATE_WDT" : 2,
            "CLOUD_UPLOAD_FAIL" : 3,
            "CLOUD_PUSH_FAIL" : 4,
            "CELLULAR_CMS_ERROR" : 5,
            "POWER_ON_OFF" : 6,
            "MEMORY_FULL_OVERWRITE" : 7,
            "ACCESS_CONTROL_OK" : 8,
            "ACCESS_CONTROL_FAIL" : 9,
            "FW_UPGRADE" : 10,
            "BATTERY_LOW" : 11,
            "CONFIG_ERROR" : 12,
            "FLASH_ERROR" : 13,
        ...
        P2PdestinationModuleID:{
            "WISE-4012": "27410",
            "WISE-4012E": "27666",
            "WISE-4050": "27472",
            "WISE-4060": "27488"
        },
        P2PdestinationModuleName:{
            "27410": "WISE-4012",
            "27666": "WISE-4012E",
            "27472": "WISE-4050",
            "27488": "WISE-4060"
        ...
        SensorRangeEmun:{
            "1280": {name:"Temperature", unit: "°C"},
            "1281": {name:"Humidity", unit: "%"},
            "1282": {name:"Atmospheric Pressure", unit: "hPa"},
            "1283": {name:"Light", unit: "Lux"},
            "1284": {name:"UV", unit: ""},
            "1285": {name:"Accelerometer X", unit: "mg"},
            "1286": {name:"Accelerometer Y", unit: "mg"},
            "1287": {name:"Accelerometer Z", unit: "mg"},
            "1288": {name:"Gyroscope X", unit: "dps"},
            "1289": {name:"Gyroscope Y", unit: "dps"},
            "1290": {name:"Gyroscope Z", unit: "dps"},
            "1291": {name:"Magnetometer X", unit: "uT"},
            "1292": {name:"Magnetometer Y", unit: "uT"},
            "1293": {name:"Magnetometer Z", unit: "uT"}
        },
        ...
        GnssSystemEnum:[ // WISE-467x only 1, 2, 4, 7
            "GPS+GLONASS",
            "GPS+Galileo",
            "Galileo+GLONASS",
            "GPS+Galileo+GLONASS",
        ...
        IoBoardErrorStatusCode:{
            "1" : "Fail to communicate with the I/O board",
            "2" : "Total of I/O channels exceeds the limitation which RF board can support",
            "4" : "Current RF firmware can't handle some I/O types of the I/O board",
            "8" : "Can't find the right RF firmware image for current network configuration"
        },
        IoBoardErrorActionCode:{
            "1" : "Please check connection between I/O and RF board Or Try to upgrade firmware",
            "2" : "Please try to upgrade firmware",
            "4" : "Please try to upgrade firmware",
            "8" : "Please try to upgrade firmware"
        }
    },
...
function multiPartTransfer(resURL, onSuccessFunc, onErrorFunc, onPorgressUpdate, file, length, type, form, formDataObj) {
    try {
        try{
...
function onAjaxErrorHandle(xhr, ajaxOptions, thrownError, resErrorCallbackFun, file){
    ...
    if(Advantech.Profile.DeviceEmun && typeof(Advantech.Profile.DeviceEmun[module].isErrorCodeJsonFormat) != 'undefined' &&
...
function onAjaxSuccessHandle(ajaxObj, httpMethod, resCallbackFun, stream){
    ...
    if( httpMethod == HTTP_GET ){
        try{
            if (ajaxObj.url.indexOf('cell_value') > -1) { // filter not ASCII printable characters in /cell_value - Nm
                stream = stream.replace(/[^\x20-\x7E]+/g, '');
            }
...
function httpGetOperation(httpMethod, resURL, resCallbackFun, resErrorCallbackFun, data, waitTime, ignoreErrHandle) {
    var ajaxObj = {};
    var isSuccess = true;
    var timeCounter = null;
    var ajaxHandler = null;
    var temp = new Date();  //Fix IE and Web browser can't update in HTTP Get
    if(httpMethod == "GET")
        ajaxObj.url = resURL + "?s=" + temp.getTime();
    else
        ajaxObj.url = resURL;
    ...
    ajaxObj.xhr = function() {
        ...
        XMLHttpRequest.onprogress = function(){
            ...
            timeCounter = setTimeout(function(){ajaxObj.error({status:0}, "timeout", "timeout");}, waitTime || 60000);
        };
        return XMLHttpRequest;
    };
    ...
    if (typeof ignoreErrHandle == 'undefined' || !ignoreErrHandle) {
        ajaxObj.statusCode = ajaxStandardErrorHandle();
    }
...
var WiseModule = {
    ioBoard:{
        "S214":{
            description: "4-ch AI and 4-ch DI",
            ao_Ch: 0,
            ai_Ch: 4,
            di_Ch: 4,
            do_Ch: 0,
            ...
            isDiFilterSupport01msInPowerSaveMode: true
        },
        "S250":{
            description: "1-port RS-485 and DIO",
            ao_Ch: 0,
            ai_Ch: 0,
            di_Ch: 6,
            do_Ch: 2,
        ...
        "S251":{
            description: "1-port RS-485 and 6-ch DI",
            ao_Ch: 0,
            ai_Ch: 0,
            di_Ch: 6,
            do_Ch: 0,
        ...
        "S414": {
            ...
            isSupportAIBurnout:true,
            aoRangeEmun:null,
            diModeEmun:Advantech.Profile.WISE_4012_DIModeTypeEmun,
            doModeEmun:Advantech.Profile.DOModeTypeEmun,
            doDataModuleFactory:function(){null;},
            aoDataModuleFactory:function(){null;},
            aiDataModuleFactory:function(){return Advantech.Data.IOData.AITypeDataFactory;},
            ...
            isSupportUniversalInput: false,
            isSupportRS485: false,
            isDiFilterSupport01msInPowerSaveMode: true
        },
        "S472":{
            description: "2-port RS-485 and 1-ch DI",
            ao_Ch: 0,
            ai_Ch: 0,
            di_Ch: 1,
            do_Ch: 0,
		...
		"S614":{
            ...
            do_Ch: 0,
			aiRangeEmun:Advantech.Profile.WISE_4012_RangeEmun,
			aiSamplingSpeedEmun:Advantech.Profile.WISE4012SamplingSpeedEmun,
            aiFilterSupport:true,
            aiPhysicalValueSupport: true,
            isSupportAIBurnout:true,
            aoRangeEmun:null,
        ...
        "S615":{
            description: "4-ch RTD",
            ao_Ch: 0,
            ai_Ch: 4,
            di_Ch: 0,
            do_Ch: 0,
            aiRangeEmun:Advantech.Profile.RTDRangeEmun,
            aiSamplingSpeedEmun:Advantech.Profile.AISamplingSpeedEmun,
            aiFilterSupport:true,
            aiPhysicalValueSupport: true,
            isSupportAIBurnout:true,
        ...
        "S617":{
            description: "1-port RS-485 and 2-ch AI and DIO",
            ao_Ch: 0,
            ai_Ch: 2,
            di_Ch: 2,
            do_Ch: 1,
            aiRangeEmun:Advantech.Profile.S617RangeEmun,
            aiSamplingSpeedEmun:Advantech.Profile.AISamplingSpeedEmun,
            aiFilterSupport:true,
            aiPhysicalValueSupport: true,
            isSupportAIBurnout:true,
            ...
            isSupportSensor: false,
            isDiFilterSupport01msInPowerSaveMode: true,
            isSupportPowerOutput: true,
            powerOutputChannel: 2
        },
        "S672":{
            description: "2 Serial Ports and 6-ch DI",
            ao_Ch: 0,
            ai_Ch: 0,
            di_Ch: 6,
            do_Ch: 0,
    ...
    baseBoard:{
        "WISE-4471":{
            ...
            isExtension:false,
            isSupportGps: false,
            isSupportBattery: false,
            isUseLowPowerMode: false,
            isSupportRfBand5: true,
            isSupportSimPinPukCounter: false,
            isSupportRegisteredServiceDomain: false,
            isNewMqttCustomGui: false,
            allowTopicLeadingSlash: false,
            fwVersion: 'A1.02 B03'
        },
        "WISE-4671":{
            description: "Outdoor NB-IoT WSN",
            hasUSB:false,
            hasSD:false,
            isCoupler: false,
            isSupportP2P: false,
            isExtension:false,
            isSupportGps: true,
            isSupportBattery: true,
            isUseLowPowerMode: true,
            isSupportRfBand5: true,
            isSupportSimPinPukCounter: true,
            isSupportRegisteredServiceDomain: true,
            isNewMqttCustomGui: true,
            allowTopicLeadingSlash: true,
            fwVersion: 'A1.03 B14'
        }
    }
};
...
$.extend(true, Advantech, {
    Data: {
        ...
        IOData: {
            ...
            AIConfigBaseData: function(index, tagName, range, enCh, enLAlarm, lAlarmMd, alarmLoVal, alarmLoScVal, enHAlarm, hAlarmMd, alarmHiVal, alarmHiScVal, phyLoScVal, phyHiScVal, mappingUnit, PE, DTim) {
                ...
                this.setPE = function(val) {
                    PE = val;
                }

                this.getDTim = function() {
                    return DTim;
                }

                this.setDTim = function(val) {
                    DTim = val;
                }
                ...
                this.setData = function(jsonObj) {
                    try {
                        ...
                        this.setPE(Number(jsonObj.PE) || 0);
                        this.setDTim(jsonObj.DTim || 5);
                    }
                    catch (e) {
                        throw e;
                    }
                ...
                this.toJson = function() {
                    ...
                    if (typeof Advantech.Profile.DeviceEmun[module].isSupportPowerOutput != 'undefined' && Advantech.Profile.DeviceEmun[module].isSupportPowerOutput) {
                        obj.PE = Number(this.getPE());
                        obj.DTim = this.getDTim();
                    }
                    return obj;
                    /*if(this.getRng() == undefined && this.getEn() == undefined){
                        return {
            ...
            DIConfigAllData: function(index, tagName, mode, En, inv, fltr, ftLo, ftHi, cntIV, cntKp, fqT, fqP) {
                ...
                this.setFtLo = function(val) {
                    //Change L/H Signal Width max value(65536=>4294967295)
                    if(val > 0 && val <= 4294967295) {
                        ftLo = val;
                    }else{
                        if(Advantech.Profile.DeviceEmun[module].isDiFilterSupport01msInPowerSaveMode ||
                            Advantech.Data.ModuleData.getInstance().getIoMode() == Advantech.Profile.IoBoardWorkingModeValue.PERFORMANCE_MODE){
                            throw new Error("Out of range 1~4294967295 in FtLo");
                        }else{

                            throw new Error("Out of range 1~6 in FtLo");//Low power mode: unit sec
                        }
                    }
                };
                ...
                this.setFtHi = function(val) {
                    if(val > 0 && val <= 4294967295) {
                        ...
                        if(Advantech.Profile.DeviceEmun[module].isDiFilterSupport01msInPowerSaveMode ||
                            Advantech.Data.ModuleData.getInstance().getIoMode() == Advantech.Profile.IoBoardWorkingModeValue.PERFORMANCE_MODE){//Low power mode: unit sec
                            throw new Error("Out of range 1~4294967295 in FtHi");
                        }else{
                ...
                this.setData = function(jsonObj) {
                    try {
                        ...
                        if(ioMode == Advantech.Profile.IoBoardWorkingModeValue.LOW_POWER_MODE){//low power mode
                        	...
                        	if (jsonObj.FqP != undefined) {
                            	this.setFqP(int(jsonObj.FqP));
							}
							if (jsonObj.FqT != undefined) {
...
*/
            /*inherited from DIOConfigBaseData*/
            DOConfigBaseData: function(index, tagName, mode, En, fsv) {
                Advantech.Data.IOData.DIOConfigBaseData.apply(this, arguments);
                var _Self = this;
                this.setMode = function(md) {
                    var type = this.getModeTypeEmun()[md];
            ...
            RelayConfigPulseOutData: function(index, tagName, mode, En, fsv, psLo, psHi) {
                ...
                this.setPsLo = function(val) {
                    var min = 5000;
                    //2017/04/17: Change maximun of DI/DO
                    if(val >= min && val <= 4294967295) {
                        psLo = val;
                    }else{
                        throw new Error("Out of range "+min+"~4294967295 in PsLo");
                    }
                };
                this.setPsHi = function(val) {
                    ...
                    if(val >= min && val <= 4294967295) {
                        ...
                        throw new Error("Out of range "+min+"~4294967295 in PsHi");
                    }
                };
            },
            ...
            DOConfigL2HDData: function(index, tagName, mode, En, fsv, ldt) {
                ...
                this.setLDT = function(val) {
                    if(val > 0 && val <= 4294967295) {
                        ...
                        throw new Error("Out of range 1~4294967295 in LDT");
                    }
                };
                this.toJson = function() {
                    return {
            ...
            DOConfigH2LDData: function(index, tagName, mode, En, fsv, hdt) {
                ...
                this.setHDT = function(val) {
                    if(val > 0 && val <= 4294967295) {
                        ...
                        throw new Error("Out of range 1~4294967295 in HDT");
                    }
                };
                this.toJson = function() {
                    return {
...
*/
            ...
            //JiaWei 2017/04/13 Add DI Frequency for calculation
            this.setValue = function(jsonObj, CfgObj) {
                ...
                //JiaWei 2017/04/12 add frequency value
...
*/
        ...
        Meter: function() {
            ...
            this.changeRange = function(min, max) {
                ...
                if ([0, min, max].indexOf(this.mMeterHandler.value()) > -1) {
                    this.mMeterHandler.value(min + 0.001) // change value for reset indicator
                }
            };
            ...
            this.drawElement = function(decimal) {
...
/*                         _Self.mChartHandler.y2Axis.tickFormat(function(d) {
    ...
    Utility: {
        ...
        */
        ...
        restartPage: function(waitSecond) {
			...
			$("body").html('<div class="container-fluid"><div class="row"><div class="col-xs-12 text-center" style="color:white;"><h1>Please wait for module restart</h1><h3><i class="fa fa-cog fa-5x fa-spin"></i></h3><h3></h3><h2>Page will be redirected after <i id="textCount">' + count +'</i> seconds...</h2></div></div></div>');
        ...
        retryAndRestartPage: function(waitSecond, callBackFun) {
            var gobalTimer = Advantech.Utility.TimerDispatchSingleton.getInstance();
            gobalTimer.ClearTimer();
            var count = 10;
            ...
            gobalTimer.EnableTimer(function() {
                if(count-- <= 0) {
                    gobalTimer.ClearTimer();
                    $("body").html('<div class="container-fluid"><div class="row"><div class="col-xs-12 text-center" style="color:white;"><h1>Please wait for module restart</h1><h3><i class="fa fa-cog fa-5x fa-spin"></i></h3><h3></h3><h2>Module is rebooting...</h2></div></div></div>');
                    retryFwReady();
                } else {
                    $("#textCount").text(count);
                }
            ...
            var retryCount = 5;
            function retryFwReady() {
                if (retryCount > 0) {
                    httpGetOperation(HTTP_GET, URL_GENERAL_STATUS,
                        function(){
            ...
            $("body").html( '<div class="container-fluid">'+
                                '<div class="row">'+
                                    '<div class="col-xs-12 text-center" style="color:white;">'+
                                        ...
                                        '<h3>Please click "Return Home" to reload web page after System Reset.</h3>'+
                                        //'<a href="http://www.advantech.com">Learn More...<i class="fa fa-arrow-circle-right"></i></a>'+
                                        '<a href="/config/index.html">Return Home...<i class="fa fa-arrow-circle-right"></i></a>'+
                                    '</div>'+
                                '</div>'+
                            '</div>');
        },
        reConnectPage: function() {
            var gobalTimer = Advantech.Utility.TimerDispatchSingleton.getInstance();
            gobalTimer.ClearTimer();
			$("body").html('<center style="color:#FFF"><div><br><br><br><br><br><br><br><br><br><br><h1><i class="fa fa-cog fa-spin"></i> <br/> Please click Reconnect button in WISE Studio to connect to module</h1><br><br><br><br><br><br><br><br><br><br><br></div><br><br><br></div></center>');
        },
            ...
            $("body").html( '<div class="container-fluid">'+
                                '<div class="row">'+
                                    '<div id="page-500" class="col-xs-12 text-center" style="color:white;">'+
                                        ...
                                        '<a href="'+ABSOLUTE_PATH+'/index.html" class="btn btn-danger btn-label-left"><span><i class="fa fa-reply"></i></span> Re-login</a>'+
                                    '</div>'+
                                '</div>'+
                            '</div>');
        },
        ...
        isHexString: function (h) {
            return /^[a-fA-F0-9]+$/.test(h);
        },
        ...
        RecordSysInfoSingleton: (function() {
            var mInstance;

            var recoredObj = function() {
                var mCurrentUID = null;
                var getUID = function() {
                    return mCurrentUID;
                };
        ...
        isValidPhoneNumber: function(phoneNumber) {
            var pattern = /^(\+?)(\d{8,})$/; //at least 8 digits
        ...
        loadAjaxContent: function(id, url, tag, onSuccess, isLoadAngular, templateId) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (url == '/config/template.html' && typeof templateId !== 'undefined' && templateId !== null) {
                        data = $('<div>').append($(data).find('#'+templateId).get()).html();
                    }
    ...
    Form: {
        ...
        CalibrationForm: (function() {
            ...
            var calibrationForm = function() {
                        ...
                        '<div id="calibrationCarousel" class="carousel slide" data-ride="carousel" data-interval="false" data-pause="hover">'+
                          //<!-- Menu -->
                            ...
                            '<div class="carousel-inner" role="listbox">'+
                              ...
                              '<div class="item">'+
                                    '<div style="with:200px; height:175px;">'+
                                        '<h4><i class="fa fa-info-circle"></i> Setting Successfully</h4>'+
                                    '</div>'+
                                    '<div class="carousel-caption" style="color:#222;">'+
                                        '<p>'+
                ...
                var showCalibrationForm = function(rangeInfo) {
                    slideTo(0);
                    calibrationDiv.find("#inpMinVal").html(rangeInfo.zero);
                    calibrationDiv.find("#inpMaxVal").html(rangeInfo.span);
                    calibrationDiv.find('#btnZero').click(function(){
                        // window.external.VComWebUtilitySyncCallBackFun('start_ai_calibration', 12000); // call c# function for derestrict timeout setting
                        Advantech.Utility.callExternalFun('start_ai_calibration', 12000);
                        ...
                        URL_DEVICE_CONTROL,
                        function(){
                            // window.external.VComWebUtilitySyncCallBackFun('end_ai_calibration', ''); // call c# function for derestrict timeout setting
                            Advantech.Utility.callExternalFun('end_ai_calibration', '');
        ...
        ProgressForm: (function() {
            ...
            var progressForm = function() {
                ...
                var updateProgressForm = function(progress, FileSize /*0~100*/ ) {
                    ...
                    (function loop(){
                        ...
                        if(barVal < currProgress && progress < 100){ //If progress is 0~99, update progress bar
                            //TimerID = setTimeout(loop, (FileSize/1024) * 0.2 * 25);    //Total upload time is about 16.5sec
                            TimerID = setTimeout(loop, 1200);    //Total upload time via VCOM is about 90 sec
            ...
            AIConfigController: function(baseForm, overviewTable, module, profile, commonConfigForm) {
                ...
                this.initialController = function() {
                    ...
                    _Self.getOverviewTable().onRowClicked(function(obj, e) {
                        var hiddenSets = $(obj).attr("data-hidden");
                        var elementIds =[];
                        ...
                        if($("#" + _Self.getBaseForm().getFormId() + " #selCh option:selected").text() !== 'Average')
                            if (typeof Advantech.Profile.DeviceEmun[profile.Id].isSupportPowerOutput != 'undefined' && Advantech.Profile.DeviceEmun[profile.Id].isSupportPowerOutput) {
                                $("#"+_Self.getBaseForm().getFormId()).find(".isChannelOnly").show();
                            } else {
                                $("#"+_Self.getBaseForm().getFormId()).find(".isChannelOnly:not(.isPowerOutputOnly)").show();
                            }
                    });
                    _Self.getBaseForm().onSubmitted(function(obj, e) {
                        ...
                        if($.isFunction(_Self.onSubmitted())) {
                            for (var i=0; i<AICfg.length; i++) {
                                if (typeof Advantech.Profile.DeviceEmun[profile.Id].isSupportPowerOutput != 'undefined'
                                    && Advantech.Profile.DeviceEmun[profile.Id].isSupportPowerOutput
                                    && AICfg[i].Ch < Advantech.Profile.DeviceEmun[profile.Id].ai_Ch // ignore average channel
                                    && (!/^[0-9]+$/.test(AICfg[i].DTim) || AICfg[i].DTim < 1 || AICfg[i].DTim > 1800)) {
                                    Advantech.Form.MessageForm.getInstance().showMessageBox("Error", "<i class='fa fa-fw fa-exclamation-triangle'></i>Power Output Delay Time must be integer and between 1~1800" , null);
                                    return;
                                }
                            }
...
/*                        if(e.channel == null)
                            ...
                            if (e.channel === 'All') {
                                var jsonObj = _Self.getOverviewTable().getTag(0);
                                jsonObj.Ch = 'All';
                            } else {
                    ...
                    _Self.getBaseForm().onSubmitted(function(obj, e) {
                        ...
                        if(e.Ch === 'All') {
                            for (var i = 0; i < _Self.getModule().getLength(); ++i) {
                                ...
                                var obj = JSON.parse(JSON.stringify(e));
                                obj.Ch = i;
                                //JiaWei: No need check DI because there is no invalid mode
                        ...
                        if($.isFunction(_Self.onSubmitted())) {
                            var module = Advantech.Utility.RecordContextPageIdSingleton.getInstance().GetCurrentModule();
                            if(Advantech.Data.ModuleData.getInstance().getIoMode() == Advantech.Profile.IoBoardWorkingModeValue.LOW_POWER_MODE &&
                                !Advantech.Profile.DeviceEmun[module].isDiFilterSupport01msInPowerSaveMode){//Low power mode: unit sec
                                for(var i=0; i< DICfg.length; i++){
                                    if(parseInt(DICfg[i].FtLo)*10 != DICfg[i].FtLo*10 || DICfg[i].FtLo < 1 || DICfg[i].FtLo > 6) {
                                        Advantech.Form.MessageForm.getInstance().showMessageBox("Error", "<i class='fa fa-fw fa-exclamation-triangle'></i>Min. Low Signal Width must be integer and between 1~6" , null);
                                        return;
                                    }
                                    if(parseInt(DICfg[i].FtHi)*10 != DICfg[i].FtHi*10 || DICfg[i].FtHi < 1 || DICfg[i].FtHi > 6) {
                                        Advantech.Form.MessageForm.getInstance().showMessageBox("Error", "<i class='fa fa-fw fa-exclamation-triangle'></i>Min. High Signal Width must be integer and between 1~6" , null);
                                        return;
                                    }
...
///
                                                    ...
                                                    "<div class='form-group'>" +
                                                        ...
                                                        "<div class='col-lg-6'>" +
                                                            "<div class='input-group'>" +
                                                                "<button class='btn btn-warning' id='btnCalibration'><i class='fa fa-wrench'></i> Restore to Default" +
                                                                "</button>" +
                                                            "</div>" +
                                                        "</div>" +
                                                    "</div>"+
                ...
                this.setForm = function(jsonObj) {
                    try{
                        ...
                        if(ioMode == 1){//Low power mode
                            ...
                            //$("#" + _Self.getFormId() + " #aiCommonConfigSmp").show();
                            $("#" + _Self.getFormId() + " #aiCommonConfigSmp").hide();
                ...
                this.setForm = function(jsonObj) {
                    try{
                        ...
                        if(typeof(physicalValueSupport)!="undefined" && !physicalValueSupport){
                            $("#" + _Self.getFormId() + " #physicalMinValue").hide();
                            $("#" + _Self.getFormId() + " #physicalMaxValue").hide();
                            //$("#" + _Self.getFormId() + " #physicalMappingUnit").hide();
                        }
                    }catch(e){
            ...
            DIPlugInConfigForm: function(formId) {
                ...
                this.initialForm = function(containerName) {
                    ...
                    configForm.innerHTML =
                        ...
                        "<div class='col-lg-8'>" +
                        "<div class='input-group' style='min-width: 20px'>" +
                        //change DI L/H signal width
                        //"<input id='inpFtLo' type='number' max='65535' min='1' class='form-control isNumericType' value='1' style='min-width: 15px'>" +
                        "<input id='inpFtLo' type='number' max='4294967295' min='1' class='form-control isNumericType' value='1' style='min-width: 15px'>" +
                        ...
                        "<input id='inpFtHi' type='number' max='4294967295' min='1' class='form-control isNumericType' value='1' style='min-width: 15px'>" +
                        "<span class='input-group-addon' >0.1ms</span>" +
                        "</div>" +
                        "</div>" +
                        "</div>" +
                    ...
                    var module = Advantech.Utility.RecordContextPageIdSingleton.getInstance().GetCurrentModule();
                    if(Advantech.Profile.DeviceEmun[module].isDiFilterSupport01msInPowerSaveMode ||
                        ioMode == Advantech.Profile.IoBoardWorkingModeValue.PERFORMANCE_MODE){
                        $("#" + _Self.getFormId() + " .diSignalWidth").html("0.1ms");// change unit in performance mode
                        $("#" + _Self.getFormId() + " #inpFtLo").attr("max", 4294967295);
                        $("#" + _Self.getFormId() + " #inpFtHi").attr("max", 4294967295);
                    }else{
                    ...
                    if(ioMode == Advantech.Profile.IoBoardWorkingModeValue.PERFORMANCE_MODE){
                ...
                this.setForm = function(jsonObj) {
                    try{
                        ...
                        if(Advantech.Profile.DeviceEmun[module].isDiFilterSupport01msInPowerSaveMode ||
                            Advantech.Data.ModuleData.getInstance().getIoMode() == Advantech.Profile.IoBoardWorkingModeValue.PERFORMANCE_MODE){//Performance mode: unit 0.1ms
                            $("#" + _Self.getFormId() + " #inpFtLo").val(jsonObj.FtLo);
                            $("#" + _Self.getFormId() + " #inpFtHi").val(jsonObj.FtHi);
                        }else{//Low power mode: unit sec
                        ...
                        throw new Error("Setting DI parameter failed at Ch "+ jsonObj.Ch);
                    }
                };
            },
/*
...
*/
            ...
            RelayPlugInPSConfigForm: function(formId) {
                ...
                this.initialForm = function(containerName) {
                    ...
                    configForm.innerHTML = "<div class='form-group isModuleInternalOnly'>" +
                        ...
                        "<input id='inpPsLo' type='number' max='4294967295' min='5000' class='form-control isNumericType' value='5000' style='min-width: 15px'>" +
                        "<span class='input-group-addon'>0.1ms</span>" +
                        "</div>" +
                        "</div>" +
                        "</div>" +
                        ...
                        "<input id='inpPsHi' type='number' max='4294967295' min='5000' class='form-control isNumericType' value='5000' style='min-width: 15px'>" +
                        "<span class='input-group-addon'>0.1ms</span>" +
                        "</div>" +
                        "</div>" +
                        "</div>" +
            ...
            DOPlugInPSConfigForm: function(formId) {
                ...
                this.initialForm = function(containerName) {
                    ...
                    configForm.innerHTML = "<div class='form-group isModuleInternalOnly'>" +
                        ...
                        "<input id='inpPsLo' type='number' max='4294967295' min='1' class='form-control isNumericType' value='1' style='min-width: 15px'>" +
                        "<span class='input-group-addon'>0.1ms</span>" +
                        "</div>" +
                        "</div>" +
                        "</div>" +
                        ...
                        "<input id='inpPsHi' type='number' max='4294967295' min='1' class='form-control isNumericType' value='1' style='min-width: 15px'>" +
                        "<span class='input-group-addon'>0.1ms</span>" +
                        "</div>" +
                        "</div>" +
                        "</div>" +
            ...
            DOPlugInL2HConfigForm: function(formId) {
                ...
                this.initialForm = function(containerName) {
                    ...
                    configForm.innerHTML = "<div class='form-group isModuleInternalOnly'>" +
                        ...
                        "<input id='inpLDT' type='number' max='4294967295' min='1' class='form-control isNumericType' value='1' style='min-width: 15px'>" +
                        "<span class='input-group-addon'>0.1ms</span>" +
                        "</div>" +
                        "</div>" +
                        "</div>";
            ...
            DOPlugInH2LConfigForm: function(formId) {
                ...
                this.initialForm = function(containerName) {
                    ...
                    configForm.innerHTML = "<div class='form-group isModuleInternalOnly'>" +
                        ...
                        "<input id='inpHDT' type='number' max='4294967295' min='1' class='form-control isNumericType' value='1' style='min-width: 15px'>" +
                        "<span class='input-group-addon'>0.1ms</span>" +
                        "</div>" +
                        "</div>" +
                        "</div>";
            ...
            IOConfigBaseForm: function(formId){
                ...
                this.dataAppended = function(obj, e) {
                    /*if(e.Type == 'DI' && e.Obj.Md==255){ //No need to skip Invalid DI, AI channel doest not go here
                ...
                var setMode = function(containerName, mdArray) {
                    if($.isArray(mdArray)) {
                        ...
                        for (var i = 0; i < mdArray.length; ++i) {
                            //no frequency setting when module is in Low power mode
                            if(mdArray[i] == "Frequency" && ioMode == Advantech.Profile.IoBoardWorkingModeValue.LOW_POWER_MODE){
                                continue;
                            }
							//Robert(2017/11/09): no DI disable modeArray
            ...
            AIOConfigBaseForm: function(formId) {
                ...
                var setMode = function(mdObj) {
                    ...
                    $($('#' + _Self.getFormId() + " #selCh option")[0]).prop("selected", "selected");
                    if (typeof Advantech.Profile.DeviceEmun[module].powerOutputChannel != 'undefined') {
                        for (var i=0; i<Advantech.Profile.DeviceEmun[module].powerOutputChannel; i++) {
                            $('#' + _Self.getFormId() + " #selPE").append($('<option>', {
                                value: i+1,
                                text: 'Power Output ' + i
                            }));
                        }
                ...
                this.initialForm = function(containerName, mdObj) {
                    ...
                    configForm.innerHTML =
                        ...
                        "<div class='form-group isChannelOnly'>" +
                            ...
                            "</div>" +
                        "</div>" +
                        "<div class='form-group isChannelOnly isPowerOutputOnly'>" +
                            "<label class='col-lg-3 control-label'>Power Output Channel Mapping</label>" +
                            "<div class='col-lg-6'>" +
                                "<div class='input-group'>" +
                                    "<select id='selPE' class='form-control'>" +
                        ...
                        "</div>" +
                        "<div class='form-group isChannelOnly isPowerOutputOnly'>" +
                            "<label class='col-lg-3 control-label'>Power Output Delay Time</label>" +
                            "<div class='col-lg-6'>" +
                                "<div class='input-group'>" +
                                    "<input type='number' class='form-control isNumericType' id='inpDTim' min='1' max='1800'>" +
                                    "<span class='input-group-addon' style='width: 5px' id='DTimUnit'>sec</span>" +
                                "</div>" +
                            "</div>" +
                        "</div>" +
                        "<div class='form-group'>" +
                        "<label class='col-lg-3 control-label'>Refresh</label>" +
                            ...
                            "</div>" +
                        "</div>" +
                        "<div class='form-group zsCalibration'>" +
                            "<label class='col-lg-3 control-label'>Calibration</label>" +
                            "<div class='col-lg-6'>" +
                            "<div class='input-group'>" +
                                "<button class='btn btn-warning' id='btnZSCalibration'><i class='fa fa-wrench'></i> Zero/Span Calibration" +
                                "</button>" +
                            "</div>" +
                            "</div>" +
                        "</div>" +
                ...
                var eventHandle = function() {
                    ...
                    $("#" + _Self.getFormId() + " #selRng").change(function() {
                        var channel = $("#" + _Self.getFormId() + " #selCh").val();
                        var rangeObj = Advantech.Profile.AIRangeInfoEmun[$(this).val()];
                        // if(channel == 0 && typeof window.external.VComWebUtilitySyncCallBackFun !== 'undefined')
                        if(channel == 0 && Advantech.Utility.checkExternalFunExist())
                            $("#" + _Self.getFormId() + " .zsCalibration").show();
                        else
                            $("#" + _Self.getFormId() + " .zsCalibration").hide();
                        //if($.isFunction(_Self.onModeChanged())) {
                            //_Self.onModeChanged()(this, {
                    ...
                    $("#" + _Self.getFormId() + " #btnZSCalibration").click(function(){
                        var range = $("#" + _Self.getFormId() + " #selRng").val();
                        var rangeObj = Advantech.Profile.AIRangeInfoEmun[range];
                        var module = Advantech.Utility.RecordContextPageIdSingleton.getInstance().GetCurrentModule();
                        if (!Advantech.Profile.DeviceEmun[module].isSupportRTD) {
                            rangeObj.zero = "0 " + rangeObj.unit;//always 0 for Zero calibration
                            rangeObj.span = rangeObj.max + " " + rangeObj.unit;
                        }
                ...
                this.setForm = function(jsonObj) {
                    try{
                        ...
                        if (typeof Advantech.Profile.DeviceEmun[module].isSupportPowerOutput != 'undefined' && Advantech.Profile.DeviceEmun[module].isSupportPowerOutput) {
                            $("#" + _Self.getFormId() + " #inpDTim").val(jsonObj.DTim);
                            $("#" + _Self.getFormId() + " #selPE").val(jsonObj.PE);
                        } else {
                            $("#" + _Self.getFormId() + " #inpDTim").closest('.form-group').hide();
                            $("#" + _Self.getFormId() + " #selPE").closest('.form-group').hide();
                        }
                        var rangeObj = Advantech.Profile.AIRangeInfoEmun[jsonObj.Rng];
                        // if(jsonObj.Ch == 0 && typeof window.external.VComWebUtilitySyncCallBackFun !== 'undefined')
                        if(jsonObj.Ch == 0 && Advantech.Utility.checkExternalFunExist())
                            $("#" + _Self.getFormId() + " .zsCalibration").show();
                        else
                            $("#" + _Self.getFormId() + " .zsCalibration").hide();
                    }catch(e){
 ...
 */
                ...
                var appendRowToDataTable = function(jsonObj) {
                    ...
                    //JiaWei: No need to hide DI disable channel
                ...
                var setTable = function(jsonObj, key) {
                    ...
                    if(row != undefined) {
                        if(row.cells){
                            ...
                            row.setAttribute("data-tag", JSON.stringify(jsonObj));
                            if (key === 'Avg') {
                                row.setAttribute("data-hidden", '.isChannelOnly');
                            }
                        }
                    }
                };
            ...
            DIOConfigOverviewTableFactory: function(OverviewTableId) {
                this.instance = function(Type, tableId) {
                    if(Type === 'DI') {
                        return Advantech.Form.IOForm.DIConfigOverviewTable(tableId, Type);
                    }else if(Type === 'DO') {
                        return Advantech.Form.IOForm.DOConfigOverviewTable(tableId, Type);
                    }
                };
            },

            //Inherit IOConfigBaseOverviewTable
            DIOConfigBaseOverviewTable: function(tableId, Type) {
                Advantech.Form.IOForm.IOConfigBaseOverviewTable.apply(this, arguments);
...
*/
            ...
            DIStatusPage: function(pageId, channelNumber) {
                Advantech.Form.IOForm.IOStatusPage.apply(this, arguments);
                //JiaWei 2017/04/12 Add frequency value for calculation
                ...
                this.updateRemoteDatas = function(channel, valueJson) {
                    //JiaWei 2017/04/12 Add DI Frequency for calculation
                    var IOConfigData = IOCfg.getConfig();
                    _Self.getCtrlList()[channel].setRemotePartByAdvJson(valueJson, IOConfigData[channel]);
                ...
                this.setValues = function(valuessJson, isInitial) {
                    try{
                        ...
                        if(valuesArray) {
                            ...
                            if(bAllDiClosed){
                                //Robert(2017/06/15): PM requests to restore original DI modes display. For DI Disable mode: 255
                                $('#' + pageId + ' #diStatusInfom').html("<h4><i class='fa fw-fa fa-info-circle'></i> No DI channel enabled. Please change DI channel Mode in DI Configuration.</h4>");
                                /*
...
*/
            ...
            UIModeSelectPage: function(pageId, channelNumber) {
                ...
                this.createPage = function(containerName, profile) {
                    ...
                    uiPageContainer.innerHTML =
                        ...
                        "<div class='panel-footer clearfix'>" +
                        "<div class='pull-right'>"+
                            '<button type="submit" class="btn btn-success" id="btnUIConfig">'+
                ...
                this.CreateIOPage = function(profileArray, slotIndex) {
                    ...
                    if(soltProfile == null){
                        ...
                        if(Advantech.Profile.DeviceEmun[currentModule] == undefined){
                            ...
                            var rtdFlag = Advantech.Profile.DeviceEmun[currentModule].isSupportRTD;
                            var powerOutputFlag = Advantech.Profile.DeviceEmun[currentModule].isSupportPowerOutput;
                            ...
                            if(typeof(rs485Flag)!='undefined' && rs485Flag){
                                for(var i = 0; i < soltProfile.RT; i++)
                                {
                            ...
                            if(typeof(rtdFlag)!='undefined' && rtdFlag){
                                this.AppendTab("TabRTD", "RTD");
                                var channelAmount = Number(soltProfile.RTD) + Number(uiChannelAmount);
                                mAIPage = new Advantech.Form.IOForm.AIStatusPage("AiStatusPage", channelAmount);
                                soltProfile.RTD = channelAmount;
                                mAIPage.createPage("TabRTD", soltProfile);
                            }
                            if(typeof(powerOutputFlag)!='undefined' && powerOutputFlag){
                                this.AppendTab("TabPowerOutput", "PowerOutput");
                            }
            ...
            DIOStatusTable: function(tableName, channelNumber, IOType) {
                ...
                this.initialTable = function(containerID) {
                    ...
                    //JiaWei(2017/03/17): Only show current mode on DO page
                    if(IOType == "DI")
                    {
            ...
            AIStatusTable: function(tableName, channelNumber, IOType) {
                ...
                this.initialTable = function(containerID, aiValueStrategy) {
                    ...
                    IndicatorElment.drawElement(Advantech.Profile.DeviceEmun[module].isSupportRTD ? 3 : 4);
                    var physicalValueSupport = Advantech.Profile.DeviceEmun[module].aiPhysicalValueSupport;
                    if(typeof(physicalValueSupport)!="undefined" && physicalValueSupport){
            ...
            IODisplayFactory: function() {
                this.createDisplayElement = function(type) {
                    ...
                    displayElement.Initial = function(id) {
                        return displayElement.initial(id);
                    };
        ...
        ConfigForm: {
            CloudConfigPanel:function(panelId){
                ...
                var mLwM2mPanelId = null;
                var mAzurePanelId = null;
                var mMqttPanelId = null;
                var mChinaTelecomPanelId = null;
                var mWisePaasPanelId = null;
                var mTSystemPanelId = null;
                var mChungHwaIotPanelId = null;
                var mSelectedCloudIndex = 0;
                ...
                this.setOtherPanelId = function(chinaTelecomPanelId, webAccessPanelId, lwM2mPanelId, mqttPanelId, azurePanelId, wisePaasPanelId, tsystemPanelId, chungHwaIotPanelId){
                    mChinaTelecomPanelId = chinaTelecomPanelId;
                    mWebAccessPanelId = webAccessPanelId;
                    mLwM2mPanelId = lwM2mPanelId;
                    mMqttPanelId = mqttPanelId;
                    mAzurePanelId = azurePanelId;
                    mWisePaasPanelId = wisePaasPanelId;
                    mTSystemPanelId = tsystemPanelId;
                    mChungHwaIotPanelId = chungHwaIotPanelId;
                }
                this.setPanel = function(selCloudIndex, jsonObj){
                    mSelectedCloudIndex = selCloudIndex;
                    _$Panel.find("#selCloud").val(selCloudIndex).trigger("change");
                    updateCloudStatusPanel(jsonObj);
                };
                this.setSelectedCloudIndex = function(index){
                    mSelectedCloudIndex = index;
                }
                ...
                var handleAuthenticateClick = function(){
                    _$Panel.find("#btnDropBoxAuthenticate").click(function(){
                        //check if cloud setting exists
                        var serviceIndex = _$Panel.find("#selCloud").val();
                        if(serviceIndex == mSelectedCloudIndex){
                ...
                var startCloudServiceWithOldSetting = function(){
                    ...
                    httpGetOperation(HTTP_PATCH,
                                URL_CLOUD_CONFIG,
                                function(){
                                    _Self.setSelectedCloudIndex(serviceVenderCode);
                ...
                var updateCloudStatusPanel = function(jsonObj){
                    if(jsonObj){
                        var tokenStatus = Advantech.Profile.CloudDropBoxTokenEmun[jsonObj.CRdy];
                        var connectStatus = Advantech.Profile.CloudConnectStatusEmun[jsonObj.Stat];
                        var code = Advantech.Profile.CloudErrorCodeEmun[jsonObj.Code];
                        _$Panel.find("#panelCloudStatus #inpCRdy").val(tokenStatus);
                        _$Panel.find("#panelCloudStatus #inpStat").val(connectStatus);
                        _$Panel.find("#panelCloudStatus #inpCode").val(code);
                    }
                    if(mSelectedCloudIndex == Advantech.Profile.CloudServiceSelectIndex.Dropbox)//dropBox
                        _$Panel.find("#panelCloudStatus #dropBoxStatus").show();
                    else
                        _$Panel.find("#panelCloudStatus #dropBoxStatus").hide();
                    /* var selCloudIndex = $("#"+_Self.getPanelId()+" #selCloud").val();
                    if(selCloudIndex != mSelectedCloudIndex || selCloudIndex == Advantech.Profile.CloudServiceSelectIndex.Disabled)
                        _$Panel.find("#panelCloudStatus").hide();
                    else
                        _$Panel.find("#panelCloudStatus").show(); */
                };
                var handleCloudServiceSelect = function(selectId){
                    ...
                    $selCloud.change(function(){
                        ...
                        if(index != mSelectedCloudIndex  || index == Advantech.Profile.CloudServiceSelectIndex.Disabled)
                            _$Panel.find("#panelCloudStatus").hide();
                        else
                            _$Panel.find("#panelCloudStatus").show();
                        //updateDeleteCloudSettingBtn(status);
                        if(index == Advantech.Profile.CloudServiceSelectIndex.ChinaTelecom){
                            _$Panel.find(".cloudPanel").hide();
                            _$Panel.find("#panelChinaTelecom").show();
                            //get setting
                            if(mChinaTelecomPanelId != null) {
                                mChinaTelecomPanelId.refreshStatus()();
                            }
                        }else if(index == Advantech.Profile.CloudServiceSelectIndex.WisePaas20){
                            _$Panel.find(".cloudPanel").hide();
                            _$Panel.find("#panelWisePaas20").show();
                            _$Panel.find("#selLogPauth").trigger("change");
                            //get setting
                            if(mWisePaasPanelId != null) {
                                mWisePaasPanelId.refreshStatus()();
                            }
                        }else if(index == Advantech.Profile.CloudServiceSelectIndex.TSystem){
                            _$Panel.find(".cloudPanel").hide();
                            _$Panel.find("#panelTSystem").show();
                            //get TSystem setting
                            if(mTSystemPanelId != null) {
                                mTSystemPanelId.refreshConfigStatus()();
                            }
                        }else if(index == Advantech.Profile.CloudServiceSelectIndex.WebAccess){
                            _$Panel.find(".cloudPanel").hide();
                        ...
                        /* }else if(index == Advantech.Profile.CloudServiceSelectIndex.Dropbox){
                            _$Panel.find(".cloudPanel").hide();
                            _$Panel.find("#panelDropBox").show(); */
                        }else if(index==Advantech.Profile.CloudServiceSelectIndex.LwM2M){
                            _$Panel.find(".cloudPanel").hide();
                            _$Panel.find("#panelLwM2M").show();
                            //get setting
                            if(mLwM2mPanelId != null) {
                                mLwM2mPanelId.refreshConfigStatus()();
                            }
                        }else if(index==Advantech.Profile.CloudServiceSelectIndex.ChungHwaTelecomIoT){
                            _$Panel.find(".cloudPanel").hide();
                            _$Panel.find("#panelChungHwaIot").show();
                            //get setting
                            if(mChungHwaIotPanelId != null) {
                                mChungHwaIotPanelId.refreshConfigStatus()();
                            }
                        }else if(index == Advantech.Profile.CloudServiceSelectIndex.MQTT){
                            _$Panel.find(".cloudPanel").hide();
                            _$Panel.find("#panelMQTT").show();
                            //get MQTT setting
                            if(mMqttPanelId != null) {
                                mMqttPanelId.refreshConfigStatus()();
                            }
                        /* }else if(index == Advantech.Profile.CloudServiceSelectIndex.Azure){
                            _$Panel.find(".cloudPanel").hide();
                            _$Panel.find("#panelAzure").show();
                            _$Panel.find("#selLogPauth").trigger("change");
                            //get Azure setting
                            if(mAzurePanelId != null) {
                                mAzurePanelId.refreshStatus()();
                            } */
                        }else if(index == Advantech.Profile.CloudServiceSelectIndex.AWS){
                            _$Panel.find(".cloudPanel").hide();
                            _$Panel.find("#panelAws").show();
                            //get AWS setting
                            /* if(mAwsPanelId != null) {
                                mAwsPanelId.refreshConfigStatus()();
                            } */
                        }else if(index == Advantech.Profile.CloudServiceSelectIndex.AzureMQTT){
                            _$Panel.find(".cloudPanel").hide();
                            _$Panel.find("#panelAzureMQTT").show();
                        }else{
                            _$Panel.find(".cloudPanel").hide();
                            _$Panel.find("#panelCloudDisable").show();
                        }
                    });
                };
            ...
            ChinaTelecomConfigPanel: function(panelId) {
                var _onDataSubmitted = null;
                var _refreshStatus = null;
                ...
                var handleSubmitted = function(){
                    $("#" + _Self.getPanelId() + " #btnChinaTelecomSubmit").click(function() {
                        if($.isFunction(_Self.onDataSubmitted())) {
                            _Self.onDataSubmitted().apply(this, [this, _Self.toJson()]);
                        }
                    });
                };
                this.setPanel = function(jsonObj) {
                    try{
                        $("#"+_Self.getPanelId()+" #logNm" ).val(jsonObj.Nm);
                ...
                this.refreshStatus = function(x) {
                    if(!arguments.length) return _refreshStatus;
                    _refreshStatus = x;
                };
                this.onDataSubmitted = function(x) {
                    if(!arguments.length) return _onDataSubmitted;
                    _onDataSubmitted = x;
                };
            },

            WisePaas20ConfigPanel: function(panelId) {
                var _onCloudSubmitted = null;
                var _refreshStatus = null;
                var mContextContainerId = panelId;
                var _Self = this;
                this.getPanelId = function() {
                ...
                var handleSubmitted = function(){
                    $("#" + _Self.getPanelId() + " #btnWisePaas20Submit").click(function() {
                        if($.isFunction(_Self.onSubmitted())) {
                            _Self.onSubmitted().apply(this, [this, _Self.toJson()]);
                        }
                    });
                };
                this.setPanel = function(jsonObj) {
                    try{
                        $("#"+_Self.getPanelId()+" #logUID" ).val(Advantech.Utility.RecordSysInfoSingleton.getInstance().getUID());
                        $("#"+_Self.getPanelId()+" #wiseNm" ).val(jsonObj.Nm);
                        $("#"+_Self.getPanelId()+" #wisePWeb").val(jsonObj.PWeb);
                        $("#"+_Self.getPanelId()+" #wiseSNm").val(jsonObj.SNm);
                        $("#"+_Self.getPanelId()+" #wiseSId").val(jsonObj.SId);
                        $("#"+_Self.getPanelId()+" #wiseHbF").val(jsonObj.HbF);
                        $("#"+_Self.getPanelId()+" #wiseUri").val(jsonObj.Uri);
                    }catch(e){
                        Advantech.Form.MessageForm.getInstance().showMessageBox("<h4>Data Error<h4>", "<h5><i class='fa fa-fw fa-exclamation-triangle'></i>Data Error during network transfer. Page will be ReLoaded!<h5>");
                        Advantech.Utility.switchToTagetHtml("index",ABSOLUTE_PATH+"/index.html");
                    }
                ...
                this.onSubmitted = function(x) {
                    if(!arguments.length) return _onCloudSubmitted;
                    _onCloudSubmitted = x;
                };
            },

            AzureConfigPanel: function(panelId) {
                var _onDataLogAzureSubmitted = null;
                var _refreshStatus = null;
                var mContextContainerId = panelId;
                var _Self = this;
                this.getPanelId = function() {
                ...
                var handleSubmitted = function(){
                    $("#" + _Self.getPanelId() + " #btnAzureSubmit").click(function() {
                        if($.isFunction(_Self.onDataLogAzureSubmitted())) {
                            _Self.onDataLogAzureSubmitted().apply(this, [this, _Self.toJson()]);
                        }
                    });
                };
                this.setPanel = function(jsonObj) {
                    try{
                        ...
                        $("#"+_Self.getPanelId()+" #logUID" ).val(jsonObj.UID);
                        $("#"+_Self.getPanelId()+" #logSAS" ).val(jsonObj.SAS);
                    }catch(e){
                        Advantech.Form.MessageForm.getInstance().showMessageBox("<h4>Data Error<h4>", "<h5><i class='fa fa-fw fa-exclamation-triangle'></i>Data Error during network transfer. Page will be ReLoaded!<h5>");
                        Advantech.Utility.switchToTagetHtml("index",ABSOLUTE_PATH+"/index.html");
                    }
                ...
                this.onDataLogAzureSubmitted = function(x) {
                    if(!arguments.length) return _onDataLogAzureSubmitted;
                    _onDataLogAzureSubmitted = x;
                };
            },
            ...
            MqttConfigPanel: function(panelId) {
                var _onDataLogMqttSubmitted = null;
                var _refreshConfigStatus = null;
                var mContextContainerId = panelId;
                ...
                this.initialPanel = function() {
                    handleFileUpload();
                    handleSubmitted();
                    handleWebSocketEnableChange();
                    handleSSLCertificateEnableChange();
                    handleCertificateFileDisplayChange();
                };
                /* var handleInputChange = function(selectId){
                    var $selMd = $("#"+_Self.getPanelId()+" #"+selectId);
                    $selMd.change(function(){
                ...
                var handleFileUpload = function(){
                    $("#" + _Self.getPanelId() + " a[data-config=FileUpgrade]").click(function(e) {
                        e.preventDefault();
                        var url = $(_Self).attr('href');
                        var id = $(_Self).attr('id');
                        Advantech.Utility.loadAjaxContent(id, url, _Self, null, true);
                    });
                ...
                var eventHandle = function() {
                    $("#" + _Self.getPanelId() + " .fileinput-exists").click(function(event) {
                        $("#" + _Self.getPanelId() + " "+$(this).attr('href')).hide("slow");
                    });
                    $("#" + _Self.getPanelId() + " .fileinput-submit").click(function(event) {
                        event.preventDefault();
                        var fileType = this.id.slice(3);
                        var element = $("#" + _Self.getPanelId() + " #inp" + fileType)[0];
                        /* var $hiddenForm = $("#" + _Self.getPanelId() + " #inp" + fileType)
                           .closest( ".input-group" ).wrap('<form id="' + fileType + '">'); */
                        ...
                        if($.isFunction(_Self.onUpgradeSubmitted())) {
                            _Self.onUpgradeSubmitted()(this, {
                                ...
                                type: uploadTypeCode
                                //form: $hiddenForm,
                                //class: this.id.slice(3)
                            });
                        }
                    });
                    $("#" + _Self.getPanelId() + " input[type=file]").change(function(event) {
                        var fileType = this.id.slice(3);
                ...
                var handleSubmitted = function(){
                    $("#" + _Self.getPanelId() + " #btnMqttSubmit").click(function() {
                        if($.isFunction(_Self.onDataLogMqttSubmitted())) {
                            _Self.onDataLogMqttSubmitted().apply(this, [this, _Self.toJson()]);
                        }
                    });
                };
                var handleWebSocketEnableChange = function() {
                    $('#' + _Self.getPanelId() + '  input[name=mqttWsType]').click(function() {
                        var val = parseInt($('#' + _Self.getPanelId() + ' input[name=mqttWsType]:checked').val(), 10);
                        if(val == 0) {
                            $("#" + _Self.getPanelId() + " #logSurl").attr('disabled', 'disabled');
                        } else {
                            $("#" + _Self.getPanelId() + " #logSurl").removeAttr('disabled');
                        }
                    });
                };
                var handleSSLCertificateEnableChange = function() {
                    $('#' + _Self.getPanelId() + '  input[name=mqttSslType]').click(function() {
                        var val = parseInt($('#' + _Self.getPanelId() + ' input[name=mqttSslType]:checked').val(), 10);
                        if(val == 0) {
                            $("#" + _Self.getPanelId() + " #logCtS").attr('disabled', 'disabled');
                        } else {
                            $("#" + _Self.getPanelId() + " #logCtS").removeAttr('disabled');
                        }
                    });
                };
                var handleCertificateFileDisplayChange = function() {
                    $('#' + _Self.getPanelId() + ' #logCtS').change(function() {
                        var val = parseInt($('#' + _Self.getPanelId() + ' #logCtS').val(), 10);
                        if(val === 0) {
                            $("#" + _Self.getPanelId() + " .caFile").hide();
                        } else {
                            $("#" + _Self.getPanelId() + " .caFile").show();
                        }
                    });
                };
                this.setPanel = function(jsonObj) {
                    try{
                        ...
                        if(module.indexOf('WISE-4671') > -1 && typeof _profile.FCS != 'undefined' && _profile.FCS & Advantech.Profile.FCSMask.UserDefinedMqtt) {
                            $("#"+_Self.getPanelId()+" #mqttAdvancedTab").show();
                        }
                        $("#"+_Self.getPanelId()+" #logUID" ).val(Advantech.Utility.RecordSysInfoSingleton.getInstance().getUID());
                        $("#"+_Self.getPanelId()+" #logNm" ).val(jsonObj.Nm);
                        $("#"+_Self.getPanelId()+" #logPWeb").val(jsonObj.PWeb);
                        if(int(jsonObj.SEn) == 1)
                            $("#"+_Self.getPanelId()+" #mqttWsEnable").prop("checked", true);
                        else
                            $("#"+_Self.getPanelId()+" #mqttWsDisable").prop("checked", true);
                        if(int(jsonObj.SSLEn) == 1)
                            $("#"+_Self.getPanelId()+" #mqttSslEnable").prop("checked", true);
                        else
                            $("#"+_Self.getPanelId()+" #mqttSslDisable").prop("checked", true);
                        if(int(jsonObj.PE) == 1)
                            $("#"+_Self.getPanelId()+" #mqttPubRetainEnable").prop("checked", true);
                        else
                            $("#"+_Self.getPanelId()+" #mqttPubRetainDisable").prop("checked", true);
                        if(int(jsonObj.We) == 1)
                            $("#"+_Self.getPanelId()+" #mqttWillRetainEnable").prop("checked", true);
                        else
                            $("#"+_Self.getPanelId()+" #mqttWillRetainDisable").prop("checked", true);
                        $("#"+_Self.getPanelId()+" #logSurl" ).val(jsonObj.Surl);
						$("#"+_Self.getPanelId()+" #logPu" ).val(jsonObj.Pu);
                        $("#"+_Self.getPanelId()+" #logPw").val(jsonObj.Pw);
                        $("#"+_Self.getPanelId()+" #logHbF").val(jsonObj.HbF);
                        $("#"+_Self.getPanelId()+" #logPubQ").val(jsonObj.PubQ);
                        $("#"+_Self.getPanelId()+" #logSubQ").val(jsonObj.SubQ);
                        $("#"+_Self.getPanelId()+" #logCtS").val(jsonObj.CtS);
                        if(parseInt($('#' + _Self.getPanelId() + ' input[name=mqttWsType]:checked').val(), 10) == 0) {
                            $("#" + _Self.getPanelId() + " #logSurl").attr('disabled', 'disabled');
                        } else {
                            $("#" + _Self.getPanelId() + " #logSurl").removeAttr('disabled');
                        }
                        if(parseInt($('#' + _Self.getPanelId() + ' input[name=mqttSslType]:checked').val(), 10) == 0) {
                            $("#" + _Self.getPanelId() + " #logCtS").attr('disabled', 'disabled');
                        } else {
                            $("#" + _Self.getPanelId() + " #logCtS").removeAttr('disabled');
                        }
                        if (parseInt($('#' + _Self.getPanelId() + ' #logCtS').val(), 10) === 0) {
                            $("#" + _Self.getPanelId() + " .caFile").hide();
                        } else {
                            $("#" + _Self.getPanelId() + " .caFile").show();
                        }
                    ...
                    $("#" + _Self.getPanelId() + " input").each(function() {
                        if(!$(this).is(":disabled") && ($(this).css("display")!='none') && $(this).is(":visible")) {
                            ...
                            if(type === "checkbox") {
                                ...
                                if(this.id === "mqttSslDisable"){
                                    obj['SSLEn'] = $('#mqttSslDisable').prop("checked")?0:1;
                                }
                                if(this.id === "mqttWsDisable"){
                                    obj['SEn'] = $('#mqttWsDisable').prop("checked")?0:1;
                                }
                                if(this.id === "mqttPubRetainDisable"){
                                    obj['PE'] = $('#mqttPubRetainDisable').prop("checked")?0:1;
                                }
                                if(this.id === "mqttWillRetainDisable"){
                                    obj['We'] = $('#mqttWillRetainDisable').prop("checked")?0:1;
                                }
                            }else{
                                obj[id] = $(this).val();
                            }
                ...
                this.refreshConfigStatus = function(x) {
                    if(!arguments.length) return _refreshConfigStatus;
                    _refreshConfigStatus = x;
                };

                this.onDataLogMqttSubmitted = function(x) {
                    if(!arguments.length) return _onDataLogMqttSubmitted;
                    _onDataLogMqttSubmitted = x;
                };
            },

            AwsConfigPanel: function(panelId) {
                var _onDataLogSubmitted = null;
                var _refreshConfigStatus = null;
                var mContextContainerId = panelId;
                var mTypeEmun = Advantech.Profile.UpgradeTypeEmun;
                var _Self = this;
                ...
                var handleSubmitted = function(){
                    $("#" + _Self.getPanelId() + " #btnAwsSubmit").click(function() {
                        if($.isFunction(_Self.onDataLogSubmitted())) {
                            _Self.onDataLogSubmitted().apply(this, [this, _Self.toJson()]);
                        }
                    });
                };
                this.setPanel = function(jsonObj) {
                    try{
                        ...
                        Advantech.Form.MessageForm.getInstance().showMessageBox("<h4>Data Error<h4>", "<h5><i class='fa fa-fw fa-exclamation-triangle'></i>Error during data transfer. Page will be ReLoaded!<h5>");
                        Advantech.Utility.switchToTagetHtml("index",ABSOLUTE_PATH+"/index.html");
                    }
                };
                this.toJson = function() {
                    ...
                    obj['Sel'] = Number($("#CloudConfigPanel #selCloud").val());//cloud type selection
                    $("#" + _Self.getPanelId() + " input").each(function() {
                        if(!$(this).is(":disabled") && ($(this).css("display")!='none') && $(this).is(":visible") && this.type !=="file") {
                            var type = this.type;
                            var id = this.id.slice(3);
                            if(type === "checkbox") {
                                obj[id] = (this.checked) ? 1 : 0;
                ...
                this.onDataLogSubmitted = function(x) {
                    if(!arguments.length) return _onDataLogSubmitted;
                    _onDataLogSubmitted = x;
                };
            },

            AzureMqttConfigPanel: function(panelId) {
                var _onDataLogMqttSubmitted = null;
                var _refreshConfigStatus = null;
                var mContextContainerId = panelId;
                var _Self = this;
                ...
                var handleSubmitted = function(){
                    $("#" + _Self.getPanelId() + " #btnAzureMqttSubmit").click(function() {
                        if($.isFunction(_Self.onDataLogMqttSubmitted())) {
                            _Self.onDataLogMqttSubmitted().apply(this, [this, _Self.toJson()]);
                        }
                    });
                ...
                this.setPanel = function(jsonObj) {
                    try{
                        ...
                        $("#"+_Self.getPanelId()+" #logPWeb").val(jsonObj.PWeb);
                        if(int(jsonObj.SEn) == 1)
                            $("#"+_Self.getPanelId()+" #azureMqttWsEnable").prop("checked", true);
                        else
                            $("#"+_Self.getPanelId()+" #azureMqttWsDisable").prop("checked", true);
                        $("#"+_Self.getPanelId()+" #logHbF").val(jsonObj.HbF);
                        $("#"+_Self.getPanelId()+" #logPubQ").val(jsonObj.PubQ);
                        $("#"+_Self.getPanelId()+" #logSubQ").val(jsonObj.SubQ);
                    }catch(e){
                    ...
                    $("#" + _Self.getPanelId() + " input").each(function() {
                        if(!$(this).is(":disabled") && ($(this).css("display")!='none') && $(this).is(":visible")) {
                            ...
                            if(type === "checkbox") {
                                ...
                                /* if(this.id === "azureMqttWsDisable"){
                                    obj['SEn'] = $('#azureMqttWsDisable').prop("checked")?0:1;
                                } */
                                if(this.id === "mqttPubRetainDisable"){
                                    obj['PE'] = $('#mqttPubRetainDisable').prop("checked")?0:1;
                                }
            ...
            TSystemConfigPanel: function(panelId) {
                var _onDataLogSubmitted = null;
                var _refreshConfigStatus = null;
                var mContextContainerId = panelId;
                var _Self = this;
                ...
                var handleSubmitted = function(){
                    $("#" + _Self.getPanelId() + " #btnTSystemSubmit").click(function() {
                        if($.isFunction(_Self.onDataLogSubmitted())) {
                            _Self.onDataLogSubmitted().apply(this, [this, _Self.toJson()]);
                        }
                    });
            ...
            L2M2mConfigPanel: function(panelId) {
                ...
                var handleSubmitted = function(){
                    $("#" + _Self.getPanelId() + " #btnLwM2MSubmit").click(function() {
                        if($.isFunction(_Self.onConfigSubmitted())) {
                            _Self.onConfigSubmitted().apply(this, [this, _Self.toJson()]);
                        }
                    });
                };
                this.setPanel = function(jsonObj) {
                    try{
                        $("#"+_Self.getPanelId()+" #logIP" ).val(jsonObj.IP);
                        $("#"+_Self.getPanelId()+" #logPWeb").val(jsonObj.PWeb);
                        if(int(jsonObj.Pauth) == 1)
                            $("#"+_Self.getPanelId()+" #m2mBootStrapEnable").prop("checked", true);
                        else
                            $("#"+_Self.getPanelId()+" #m2mBootStrapDisable").prop("checked", true);
                        if(int(jsonObj.SSLEn) == 1)
                            $("#"+_Self.getPanelId()+" #m2mDtlsEnable").prop("checked", true);
                        else
                            $("#"+_Self.getPanelId()+" #m2mDtlsDisable").prop("checked", true);
                        if(int(jsonObj.SEn) == 1)
                            $("#"+_Self.getPanelId()+" #m2mPskHex").prop("checked", true);
                        else
                            $("#"+_Self.getPanelId()+" #m2mPskAscii").prop("checked", true);
                        $("#"+_Self.getPanelId()+" #logUurl" ).val(jsonObj.Uurl);
                        $("#"+_Self.getPanelId()+" #logId").val(jsonObj.Id);
                        $("#"+_Self.getPanelId()+" #logHbF").val(jsonObj.HbF);
                    }catch(e){
                        Advantech.Form.MessageForm.getInstance().showMessageBox("<h4>Data Error<h4>", "<h5><i class='fa fa-fw fa-exclamation-triangle'></i>Data Error during network transfer. Page will be ReLoaded!<h5>");
                        Advantech.Utility.switchToTagetHtml("index",ABSOLUTE_PATH+"/index.html");
                    ...
                    $("#" + _Self.getPanelId() + " input").each(function() {
                        if(!$(this).is(":disabled") && ($(this).css("display")!='none') && $(this).is(":visible")) {
                            ...
                            if(type === "checkbox") {
                                ...
                                if(this.id === "m2mDtlsDisable"){
                                    obj['SSLEn'] = $('#m2mDtlsDisable').prop("checked")?0:1;
                                }
                                if(this.id === "m2mBootStrapDisable"){
                                    obj['Pauth'] = $('#m2mBootStrapDisable').prop("checked")?0:1;
                                }
                                if(this.id === "m2mPskAscii"){
                                    obj['SEn'] = $('#m2mPskAscii').prop("checked")?0:1;
                                }
                            }else{
                                obj[id] = $(this).val();
                            }
                ...
                this.onConfigSubmitted = function(x) {
                    if(!arguments.length) return _onConfigSubmitted;
                    _onConfigSubmitted = x;
                };
            },

            ChungHwaIotConfigPanel: function(panelId) {
                var _onConfigSubmitted = null;
                var _refreshConfigStatus = null;
                var mContextContainerId = panelId;
                var _Self = this;
                ...
                var handleSubmitted = function(){
                    $("#" + _Self.getPanelId() + " #btnChungHwaIotSubmit").click(function() {
                        if($.isFunction(_Self.onConfigSubmitted())) {
                            _Self.onConfigSubmitted().apply(this, [this, _Self.toJson()]);
                        }
                    });
                ...
                this.setPanel = function(jsonObj) {
                    try{
                        $("#"+_Self.getPanelId()+" #logId" ).val(jsonObj.Id);
                        $("#"+_Self.getPanelId()+" #logAKey").val(jsonObj.AKey);
                        $("#"+_Self.getPanelId()+" #logHbF" ).val(jsonObj.HbF);
                        $("#"+_Self.getPanelId()+" #logPubQ").val(jsonObj.PubQ);
                        $("#"+_Self.getPanelId()+" #logSubQ").val(jsonObj.SubQ);
                    }catch(e){
                        Advantech.Form.MessageForm.getInstance().showMessageBox("<h4>Data Error<h4>", "<h5><i class='fa fa-fw fa-exclamation-triangle'></i>Data Error during data transfer. Page will be ReLoaded!<h5>");
                        Advantech.Utility.switchToTagetHtml("index",ABSOLUTE_PATH+"/index.html");
                    }
                };
                this.toJson = function() {
            ...
            FileUpgradePanel: function(panelId) {
                ...
                var eventHandle = function() {
                    $("#" + _Self.getPanelId() + " .fileinput-submit").click(function(event) {
                        ...
                        if(false){
                        //if(/*profile != null && */profile.length > 1 && uploadTypeCode == 0){
            ...
            CouplerInfoPanel: function(panelId) {
                ...
                this.setCouplerInfoPanel = function(jsonObj) {
                    try{
                        ...
                        var profileFwMatches = profile.FwVer.match(pattern);
...
/*                        if(this.getSlotNumber() === 1) {
                ...
                this.setRFInfoPanel = function(jsonobj){
                    try {
                        if(parseInt(jsonobj.Md) == 0)
                        {
                            $("#" + _Self.getPanelId() + " #RadioHigh").prop('checked', true).trigger('click');
                            $("#" + _Self.getPanelId() + " #RadioLow").prop('checked', false).trigger('click');
                        } else {
                            $("#" + _Self.getPanelId() + " #RadioHigh").prop('checked', false).trigger('click');
                            $("#" + _Self.getPanelId() + " #RadioLow").prop('checked', true).trigger('click');
                        }
                        if(parseInt(jsonobj.ACnty) == 0)
                        {
                            $("#" + _Self.getPanelId() + " #RadioUS").prop('checked', true).trigger('click');
                            $("#" + _Self.getPanelId() + " #RadioEU").prop('checked', false).trigger('click');
                        } else {
                            $("#" + _Self.getPanelId() + " #RadioUS").prop('checked', false).trigger('click');
                            $("#" + _Self.getPanelId() + " #RadioEU").prop('checked', true).trigger('click');
                        }
                        document.getElementById("RadioAmd").checked = (parseInt(jsonobj.AMd) == 1)?true:false;
                        $("#" + _Self.getPanelId() + " #inpCh").val(jsonobj.ACh);
                        $("#" + _Self.getPanelId() + " #inpMac").val(jsonobj.MAC);
                    } catch (e) {
                        throw new Error("Setting RF Information panel failed.");
                    }
                }
                this.setRFValueTable = function(jsonObj) {
                    try{
                        var dev = jsonObj;
                        //addRowToSlotInfoTable(index);
                        var slot = dev.SL;
                        var $row = $("#" + _Self.getPanelId() + " #row1");
                        var $columns = $($row).find("td");
                        $columns[1].innerHTML = dev.Id || "";
                        $columns[2].innerHTML = dev.AMd;
                        $columns[3].innerHTML = dev.ACnty;
                        $columns[4].innerHTML = dev.ACh;
                        $columns[5].innerHTML = dev.MAC
            ...
            SlotInfoPanel: function(panelId, slotNumber) {
                ...
                this.setSlotInfoPanel = function(jsonObj) {
                    try{
                        ...
                        if(typeof(devArray.length) == "undefined")
                        {
                                var slot = 0;//devArray[i].SL;
                                var $row = $("#" + _Self.getPanelId() + " #row" + slot);
                                var $columns = $($row).find("td");
                                $columns[1].innerHTML = devArray.Id || "";
                                $columns[2].innerHTML = getSlotDescription(devArray);
                                $columns[3].innerHTML = getFirmwareDescription(devArray);
                        }
                        else
                        {
                            for (var i = 0; i < devArray.length; ++i) {
                                var slot = i;//devArray[i].SL;
                                var $row = $("#" + _Self.getPanelId() + " #row" + slot);
                                var $columns = $($row).find("td");
        ...
        AdvancedForm: {
            ...
            DataViewerPanel: function(panelId, tableId, pieContainerId, barContainerId, trendContainerId, panelType) {
                ...
                this.updateFltrValue = function(jsonObj){
                    ...
                    $("#" + _Self.getPanelId() + " #inpAmt").val(jsonObj.Amt).prop('max', jsonObj.Total).prop('min',1);
                ...
                var addSaveButton = function(){
					...
					if((Advantech.Utility.isChrome() || Advantech.Utility.isFirefox())
						...
						$('<a target="_blank" href="' + data + '" download="data.json"  class="btn btn-success"><i class="fa fa-download"></i> Save</a>').appendTo("#" + _Self.getPanelId() + ' .btn-group');
					}
                };
                ...
                var refreshTable = function(raw){
                    ...
                    //     }
                    // }
                    visibleData = mRawDatas; // no limit on length of visible data
                ...
                this.initialPanel = function() {
                    ...
                    if( !(int(isIE) < 10) || isIE == false){
                        ...
                        //Robert(2017/06/23): disable page to prevent error message in WISE Studio when use old IE version
                        ...
                        if(panelType=="io")
                            $("#panelDataLogViewer").html('<div class="row"><center><h3><i class="fa fa-fw fa-exclamation-triangle"></i>Data Query Function is Not Supported by your Web browser.</center></h3></div>');
                        else
                            $("#panelSystemLogViewer").html('<div class="row"><center><h3><i class="fa fa-fw fa-exclamation-triangle"></i>Data Query Function is Not Supported by your Web browser.</center></h3></div>');
                        return;
                    }
                    ...
                    $('[data-select="slot"]').change(function(){
                        ...
                        if(panelType != 'system' && _worker != null){
                            $("#" + _Self.getPanelId() + " .dataType").hide();
                            $("#" + _Self.getPanelId() + " .processingType").show();
                            _worker.postMessage({command:'initial', data:{raw:rawData, slot:val}});
                        }
                    });
					...
					if((Advantech.Utility.isChrome() || Advantech.Utility.isFirefox())
						...
						&& !Advantech.Utility.isIPad()
						&& !Advantech.Utility.isAndroid()){
						$("#" + _Self.getPanelId() + " #btnSave").click(function() {
							//_Self.clearDataTable()
							if($.isFunction(_Self.onDataViewSaved())) {
								_Self.onDataViewSaved().apply(this, [this, _Self.toJson(), mPanelType]);
							}
						});
					}else{
						//not for IE
						$("#" + _Self.getPanelId() + " #btnSave").hide();
					}
            ...
            DataLogOptionPanel: function(panelId) {
                ...
                this.initialPanel = function(hasAi, hasAo, hasRtd) {
                    if(hasAi === false) {
                ...
                var getAIODataOptionCount = function(type) {
                    ...
                    if(type === 'AI') {
                        ...
                        return $("#" + _Self.getPanelId() + " .rtdType input").length;
                    }else{
                        return count;
                    }
                }
                this.setPanel = function(jsonObj) {
                    try{
                        ...
                        var rtdLgDataOptionArray = Advantech.Utility.convertMaskToArray(Number(jsonObj.AILgD), getAIODataOptionCount('RTD'));
                        ...
                        $("#" + _Self.getPanelId() + " .rtdType input").each(function() {
                            var idx = this.id.slice(dividePos);
                            $(this).prop("checked", rtdLgDataOptionArray[idx]);
                        });
                ...
                this.toJson = function() {
                    ...
                    if($('.rtdType').is(':visible')) {
                        jsonObj.AILgD = getRTDLgDJson();
                    }
                    return jsonObj;
                };
            ...
            DataLogSensorOptionPanel: function(panelId) {
                ...
                this.initialPanel = function(hasSensor) {
                    if(hasSensor === false) {
                ...
                this.setPanel = function(jsonObj) {
                    try{
                        ...
                        $("#" + _Self.getPanelId() + " .sensorType input").each(function() {
...
/*                this.onDataLogSensorOptionSubmitted = function(x) {
            ...
            DataLogOptionalPanel: function(panelId) { //now only position option
                var mContextContainerId = panelId;
                var _Self = this;
                this.getPanelId = function() {
                    return mContextContainerId;
                ...
                this.setPanel = function(jsonObj) {
                    try{
                        $("#" + _Self.getPanelId() + " .optionType input").each(function() {
                            //var idx = this.id.slice(idLength);
                            $(this).prop("checked", jsonObj.En);
                        });
                    }catch(e){
                        throw new Error("Setting Option log logger failed.")
                    }
                }
                this.toJson = function() {
                    var jsonObj = {};
                    if($('.optionType').is(':visible')) {
                        jsonObj.En = boolToNumber($("#" + _Self.getPanelId() + " .optionType input").prop('checked')); //getSLgDJson();
                    }
                    return jsonObj;
                }
                var boolToNumber = function(val) {
            ...
            DataLogLoggerConfigPanel: function(panelId) {
                ...
                this.toJson = function() {
                    var jsonObj = {};
                    var containers = ['push_output']; //['log_upload', 'push_output'];
            ...
            DataLogConditionPanel: function(panelId) {
                ...
                this.setPanel = function(jsonObj) {
                    try{
                        //var isDataLogEnable = Advantech.Utility.getBitStatusFromMask(jsonObj.En, Advantech.Profile.DataLoggerStatusEmun.EmunUsefulLength, Advantech.Profile.DataLoggerStatusEmun.IoDataLogger);
                        ...
                        if(jsonObj.PE != undefined){ //positioning
                            $("#" + _Self.getPanelId() + " #inpPE").prop("checked", (int(jsonObj.PE) ==1)?true:false);
                       }
                    }catch(e){
            ...
            DataLogSlotMaskPage: function(panelId, idx) {
                ...
                this.initialPage = function(profileObj) {
                    ...
                    for (var i = 0; i < typeArray.length; ++i) {
                        ...
                        var channelNumber;
                        if (iOType == 'RTD') {
                            channelNumber = (profileObj != null) ? parseInt(profileObj[iOType], 10) : 0;
                        } else {
                            var profileProp = iOType + "n";
                            channelNumber = (profileObj != null) ? parseInt(profileObj[profileProp], 10) : 0;
                        }
                        if( (iOType == "AI" || iOType == "RTD") && channelNumber > 0){
                            channelNumber++;/*Avg*/
                        }
                    ...
                    if (profileObj != null && parseInt(profileObj['RTD'], 10) > 0) {
                        mAIPage = typeArray[4].pageHandle; // RTD
                    }
            ...
            DataLogChannelMaskPanel: function(panelId, slotNumber) {
                ...
                this.initialPanel = function(profileArray) {
                    ...
                    for (var i = 0; i < _Self.getSlotNumber(); ++i) {//check all slots
                        if(i < profileLength) {
                            var slot = i;//profileArray.Dev[i].SL;
                        ...
                        //if IO not exists, hide tab
                        var defaultActiveTabType = '';
                        if(profileArray.Dev[i].DIn == 0){
                            $("#" + _Self.getPanelId() +  " #"+ containerId + i + " #diLiId").hide();
                        }else{
                            if(defaultActiveTabType == '')
                                defaultActiveTabType = "DI";
                        }
                        if((profileArray.Dev[i].DOn + profileArray.Dev[i].RLAn) == 0){
                            $("#" + _Self.getPanelId() +  " #"+ containerId + i + " #doLiId").hide();
                        }else{
                            if(defaultActiveTabType == '')
                                defaultActiveTabType = "DO";
                        }
                        if((profileArray.Dev[i].AIn + profileArray.Dev[i].AIn) == 0){
                            $("#" + _Self.getPanelId() +  " #"+ containerId + i + " #aiLiId").hide();
                        }else{
                            if(defaultActiveTabType == '')
                                defaultActiveTabType = "AI";
                        }
                        if(profileArray.Dev[i].AOn == 0){
                            $("#" + _Self.getPanelId() +  " #"+ containerId + i + " #aoLiId").hide();
                        }else{
                            if(defaultActiveTabType == '')
                                defaultActiveTabType = "AO";
                        }
                        if(profileArray.Dev[i].RTD == 0){
                            $("#" + _Self.getPanelId() +  " #"+ containerId + i + " #rtdLiId").hide();
                        }else{
                            if(defaultActiveTabType == '')
                                defaultActiveTabType = "RTD";
                        }
                        if(defaultActiveTabType != ''){
                            $("#" + _Self.getPanelId() +  " #"+ defaultActiveTabType.toLowerCase() + 'LiId').addClass('active');
                            $("#" + _Self.getPanelId() +  " #"+ getIOContainerId(i, defaultActiveTabType)).addClass('active');
                        }
                    }
                ...
                var getIOContainerId = function(slotId, ioType) {
                    return "page" + ioType + "_SL" + slotId;
                };
            },
            ...
            AccessCrtlTable: function(tableId, ctrlNumber) {
                ...
                var addRowToAccessCtrlTable = function(index) {
                    ...
                    for (var i = 0; i < 3; ++i) {
                        ...
                        if(i == 0)
                            ...
                            cell.innerHTML = "<select id='txtbarAccessMode" + index + "' class='form-control'>" +
                            "<option value='0'>Alert</option>" +
                            "<option value='1'>Remote Control</option>" +
                            //"<option value='2'>Remote Reboot</option>" +
                            "</select>";
                        }
                        else if(i == 2){
                            cell.innerHTML = "<input type='text' id='txtbarAccessCtrlAddress" + index + "' class='form-control' style='min-width: 150px;'>";
                        }
                    }
                    $("#" + _Self.getTableId() + " tbody").append(row);
                ...
                var isValid = function($element, $targetContainer){
                    ...
                    if( $element[0].type=='text'){
                        if(!Advantech.Utility.isValidPhoneNumber(val)){
                            isValid = false;
                            $element.val("09123456");
                        }
                    }
                    if(!isValid){
                        $targetContainer.addClass("danger");
                        Advantech.Form.MessageForm.getInstance().showMessageBox("<h4>Format Error<h4>", "<h5><i class='fa fa-fw fa-exclamation-triangle'></i>Phone number format error!<h5>");
                    }
                };
                var setupTable = function() {
                    ...
                    $("#" + _Self.getTableId() + " tbody").append("<tr class='text-right'>\
                        <td colspan='3'><button class='btn btn-success' id='btnSubmit'><i class='fa fa-check'></i> Submit\
                        </button></td></tr>");
                };
                this.setAccessCtrlTb = function(jsonObj) {
                    try{
                        ...
                        for (var i = 0; i < accessCtrlArray.length; ++i) {
                            ...
                            $("#" + _Self.getTableId() + " #txtbarAccessMode" + accessCtrlArray[i].Idx).val(accessCtrlArray[i].Md);
                    ...
                    if(idx == 'All') {
                        for (var i = 0; i < this.getTotalNumber(); ++i) {
                            access_control.push({
                                ...
                                Md: parseInt($("#" + this.getTableId() + " #txtbarAccessMode" + i).val(), 10),
                        ...
                        if(idx < this.getTotalNumber()) {
                            access_control.push({
                                ...
                                Md: parseInt($("#" + this.getTableId() + " #txtbarAccessMode" + idx).val()),
