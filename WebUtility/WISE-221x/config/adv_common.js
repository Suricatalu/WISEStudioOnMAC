...
var HTTP_POST = "POST";
var URL_BASE = "/";
// var URL_BASE = "http://localhost/rest.php/wise2210/";
...
$.extend(true, Advantech, {
    Profile: {
        ...
        AISamplingSpeedEmun:{
            ...
            "1": "100 Hz/Ch",
            "2": "1000 Hz/Ch",
			"16": "1 sample/(RF periodical interval) per Channel",
            "128": "10 Hz/Total"
        },
        WISE2210SamplingSpeedEmun:{
            "16": "1 sample/(RF periodical interval) per Channel"
        },
        ...
        CloudErrorCodeEmun: {
            ...
            //Azure
            70:  "WebSocket connection was unexpectedly aborted",
            71:  "Receive WebSocket disconnection unexpectedly",
            //WebAccess
...
/*     boardFunction:{
    ...
    baseBoard:{
        "WISE-2210":{
            description: "LPWAN WSN with CT Node",
            ao_Ch: 0,
            ai_Ch: 3,
            di_Ch: 0,
            do_Ch: 0,
            aiRangeEmun:Advantech.Profile.WISE_2210_RangeEmun,
            aiSamplingSpeedEmun:Advantech.Profile.WISE2210SamplingSpeedEmun,
            aoRangeEmun:null,
            diModeEmun:null,
            doModeEmun:null,
            doDataModuleFactory:function(){null;},
            ...
            isExtension:false,
            isSupportCT: true,
            spanCalibrationDesc: "DC 90mA or AC 100mA"
        },
        "WISE-2211":{
            description: "LPWAN WSN with Transmitter",
            ao_Ch: 0,
            ai_Ch: 3,
            di_Ch: 0,
            do_Ch: 0,
            aiRangeEmun:Advantech.Profile.WISE_2211_RangeEmun,
            aiSamplingSpeedEmun:Advantech.Profile.WISE2210SamplingSpeedEmun,
            aoRangeEmun:null,
            diModeEmun:null,
            doModeEmun:null,
...
$.extend(true, Advantech, {
    Data: {
        ...
        IOData: {
            ...
            AICommonData: function(EnB, BMd, AvgM, Smp, Res, aiCgObj, AiT){
                ...
                this.setData = function(jsonObj) {
                    try {
                        ...
                        //no average channel in WISE-2210
...
*/
            ...
            //Add DI Frequency for calculation
        ...
        */
        ...
        sprintFlowValue:function(input, precision){
            ...
            if(tmp.toString().indexOf(".") !=- 1 ){
                ...
                return parseFloat(input.toString().substring(0,pos)+ input.toString().substring(pos, pos+precision+1));
            }else{
        ...
        CalibrationForm: (function() {
            ...
            var calibrationForm = function() {
                            ...
                            '<div class="carousel-inner" role="listbox">'+
                              ...
                              '<div class="item active">'+
                                '<div style="with:200px; height:175px;">'+
                                    ...
                                    '<p>Please supply <i id="inpZeroCaliVal" style="font-weight:bold; font-size:20px;"></i> to the <i style="font-weight:bold; font-size:20px;">Channel 0</i> of the module.</p>'+
                                '</div>'+
                                '<div class="carousel-caption" style="color:#222;">'+
                                    '<p>'+
                              ...
                              '</div>'+
                                ...
                                '<div class="item">'+
                                    ...
                                    '<p>Please supply <i id="inpSpanCaliVal" style="font-weight:bold; font-size:20px;"></i> to the <i style="font-weight:bold; font-size:20px;">Channel 0</i> of the module.</p>'+
                                '</div>'+
                                    '<div class="carousel-caption" style="color:#222;">'+
                                        '<p>'+
                ...
                var showCalibrationForm = function(rangeInfo) {
                    slideTo(0);
                    calibrationDiv.find("#inpZeroCaliVal").html(rangeInfo.zero+" " +rangeInfo.unit);
                    calibrationDiv.find("#inpSpanCaliVal").html(rangeInfo.span);
...
///
            ...
            DIPlugInConfigForm: function(formId) {
                ...
                this.initialForm = function(containerName) {
                    ...
                    if(ioMode == 1){
                        $("#" + _Self.getFormId() + " .diFreConfigs").hide();
                    }else{
                        $("#" + _Self.getFormId() + " .diFreConfigs").show();
                    }
                };
                this.setForm = function(jsonObj) {
                    try{
...
*/
            ...
            IOConfigBaseForm: function(formId){
                ...
                this.toJson = function() {
                    ...
                    //set default frequency value to prevent data check error when IO board is in Low power mode
                    var ioMode = Advantech.Data.ModuleData.getInstance().getIoMode();
                    if(ioMode == 1){
                        obj["FqT"] = Number($("#" + _Self.getFormId() + " #inpFqT").val());
                        obj["FqP"] = Number($("#" + _Self.getFormId() + " #selFqP").val());
                    }
                    $("#" + _Self.getFormId() + " select").each(function() {
                        if(!$(this).is(":disabled") && ($(this).css("display")!='none') && $(this).is(":visible")){
                            var id = this.id.slice(3);
...
*/
                this.initialConfigs = function(configsJson, commonObj) {
                    ...
                    if(configArray) {
                        ...
                        throw new Error("AI Config JSON data Format Error.");
                    }
                };
                this.setConfigs = function(configsJson) {
                    ...
                    }else if(configsJson["Smp"]  != undefined){
            ...
            DIStatusPage: function(pageId, channelNumber) {
                Advantech.Form.IOForm.IOStatusPage.apply(this, arguments);
                //Add frequency value for calculation
...
*/
            ...
            AIMinTypeDisplay:function(aIStatusTable){
                ...
                this.setRow = function(idx ,aiValObj){
                    ...
                    if(row.length > 0){
                        ...
                        if(range=='UDI'){
                            val = aiValObj.LEgF;
                        /* }else if(typeof(specialFlag) != 'undefined'){ //for WISE-4012E AI
                            val = parseFloat(aiValObj.LEgF/1000.0); */
                        }else{
                            if(unit=="V" || unit=="A"){
                                val = parseFloat(aiValObj.LEgF/1000.0);
                            }else{
                ...
                this.setRow = function(idx ,aiValObj){
                    ...
                    if(row.length > 0){
                        ...
                        if(range=='UDI'){
                            val = aiValObj.HEgF;
                        /* }else if(typeof(specialFlag) != 'undefined'){ //for WISE-4012E AI
                            val = parseFloat(aiValObj.HEgF/1000.0); */
                        }else{
                            if(unit=="V" || unit=="A"){
                                val = parseFloat(aiValObj.HEgF/1000.0);
                            }else{
                    ...
                    if(row.length > 0){
                        ...
                        if(aiValObj.Evt == 0){
                            if(range=='UDI'){
                                val = aiValObj.EgF;
                            /* }else if(typeof(specialFlag) != 'undefined'){ //for WISE-4012E AI
                                val = parseFloat(aiValObj.EgF/1000.0); */
                            }else{
                                if(unit=="V" || unit=="A"){
                                    val = parseFloat(aiValObj.EgF/1000.0);
                                }else{
        ...
        ConfigForm: {
            CloudConfigPanel:function(panelId){
                ...
                this.setOtherPanelId = function(privateServerPanelId, webAccessPanelId, azurePanelId){
                ...
                this.setPanel = function(selCloudMask, jsonObj){
                    ...
                    mSelectedCloudIndex = selServiceValue;
                ...
                var handleCloudServiceSelect = function(selectId){
                    ...
                    $selCloud.change(function(){
                        ...
                        if(index != mSelectedCloudIndex  || index == Advantech.Profile.CloudServiceVenderEmun.Disabled)
                            _$Panel.find("#panelCloudStatus").hide();
                        else
                            _$Panel.find("#panelCloudStatus").show();
                        //updateDeleteCloudSettingBtn(status);
                        ...
                        }else if(index == Advantech.Profile.CloudServiceVenderEmun.Azure){
                            _$Panel.find("#panelCloudLinkStatus").hide();
                            _$Panel.find("#panelPrivateServer").hide();
                            _$Panel.find("#panelCloudDisableStatus").hide();
                            _$Panel.find("#panelWebAccess").hide();
