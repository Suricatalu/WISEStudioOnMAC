...
var HTTP_POST = "POST";
var URL_BASE = "/";
// var URL_BASE = "http://localhost/rest.php/wise4210/";
...
var URL_LPWAN_DEFAULT_LIST = URL_BASE + "lpwan_defaultlist";
var URL_LPWAN_NODE = URL_BASE + "lpwan_node";
...
var URL_IFTTT_CONFIG = URL_BASE + "ifttt_config";
var URL_SITE_SURVEY_CONFIG = URL_BASE + "lpwan_siteconfig";
var URL_SITE_SURVEY_STATUS = URL_BASE + "lpwan_sitestatus";
var URL_LPWAN_DIAGNOSIS = URL_BASE + "lpwan_diagnosis";
var URL_LPWAN_WHITELIST = URL_BASE + "lpwan_allowlist";
var URL_LOGOUT = URL_BASE + "logout";
var URL_STACKLIGHT_SENSOR_CONFIG = URL_BASE + "slsensor_config";
var URL_STACKLIGHT_SENSOR_VALUE = URL_BASE + "slsensor_value";
...
$.extend(true, Advantech, {
    Profile: {
        ...
        Parameter:{
            POLLING_RATE: 1000,
			VCOM_POLLING_RATE: 2000,
            VCOM_CONFIG_WAIT_MS: 500,
        },
        WEB_ERROR_CODE:{
        ...
        DataLogIOTypeEmun: [
            ...
            "Invalid",
            "Invalid",
            "Stack light sensor state",
            "Stack light sensor illumination",
            "Stack light sensor blink frequency",
            "Stack light sensor high count",
            "Stack light sensor low count",
            "Stack light sensor fask blink count",
            "Stack light sensor slow blink count",
            "Stack light sensor high total time (0.1s)",
            "Stack light sensor low total time (0.1s)",
            "Stack light sensor fast blink total time (0.1s)",
            "Stack light sensor slow blink total time (0.1s)",
            "Invalid",
            "Invalid",
            "Invalid",
            "Invalid",
        ...
        DataLogEventTypeEmun: [//for sub-1G AP
            "Reserved", /*event 0*/
            "Reserved", /*event 1*/
            "Reserved", /*event 2*/
            "Reserved", /*event 3*/
            "Cloud file upload",
            "Cloud data push/MQTT",
            "SNTP fail",
            "Power on/off",
        ...
        DataLogNodeEventTypeEmun: [//for sub-1G Node
            "Reserved", /*event 0*/
            "Reserved", /*event 1*/
            "Reserved", /*event 2*/
            "Reserved", /*event 3*/
        ...
        ModbusCoilTagEmun: {
            ...
            BR: "Battery Status",
            TIM: "Timestamp",
            AIn: "AI raw value of all nodes",
            Stat: "Module Status of all nodes",
            TmF: "Timestamp of all nodes",
            BVer: "Battery Voltage",
            Lc: "Link Status",
            ClrL: "Stack Light Sensor clear low state count",
            ClrH: "Stack Light Sensor clear high state count",
            ClrSB: "Stack Light Sensor clear slow blink state count",
            ClrFB: "Stack Light Sensor clear fast blink state count",
            HisL: "Stack Light Sensor clear low state total time",
            HisH: "Stack Light Sensor Clear high state total time",
            HisSB: "Stack Light Sensor Clear slow blink state total time",
            HisFB: "Stack Light Sensor Clear fast blink state total time"
        },
        ModbusRegisterTagEmun: {
            DI: "DI Status",
            CtS: "Counter Switch",
            CtClr: "Clear Counter",
            CtOv: "Clear Overflow",
            ...
            BVer: "Battery Voltage",
            Lc: "Link Status",
            LB: "Stack Light Sensor Illumination",
            SSt: "Stack Light Sensor Status",
            SFq: "Stack Light Sensor Frequency",
            LVal: "Stack Light Sensor Low count",
            HVal: "Stack Light Sensor High count",
            SBVal: "Stack Light Sensor Slow Blink count",
            FBVal: "Stack Light Sensor Fast Blink count",
            LEgF: "Stack Light Sensor Low Total Time",
            HEgF: "Stack Light Sensor High Total Time",
            SBEgF: "Stack Light Sensor Slow Blink Total Time",
            FBEgF: "Stack Light Sensor Fast Blink Total Time"
        },
        FCSMask: {
            "SiteSurvey" :1,
            "RFDownlinkMode":2
        },
        CloudServiceVenderEmun: {//for cloud service support check
            "Disabled":0,
            "Dropbox" :1,
            "AliyunOSS":2,
            "PrivateServer":4,
        ...
        CloudServiceSelectIndex: {//for cloud service select
            "Disabled":0,
            "Dropbox" :1,
            "AliyunOSS":2,
            "PrivateServer":4,
        ...
        CloudErrorCodeEmun: {
            ...
            78:  "Number of messages exceeds IoT Hub quota",
            //WebAccess
        ...
        SensorRangeEmun:{
            ...
            "4224": {name:"UV", unit: ""},
            "4256": {name:"Accelerometer X", unit: "mg"},
            "4257": {name:"Accelerometer Y", unit: "mg"},
            "4258": {name:"Accelerometer Z", unit: "mg"},
            "4288": {name:"Gyroscope X", unit: "dps"},
            "4289": {name:"Gyroscope Y", unit: "dps"},
            "4290": {name:"Gyroscope Z", unit: "dps"},
            "4320": {name:"Magnetometer X", unit: "uT"},
            "4321": {name:"Magnetometer Y", unit: "uT"},
            "4322": {name:"Magnetometer Z", unit: "uT"}
        },
        DefaultRangeEmun:{
            "4096": {name:"Temperature(°C)", unit: "°C"},
            "4097": {name:"Temperature(°F)", unit: "°F"},
...
function onAjaxErrorHandle(xhr, ajaxOptions, thrownError, resErrorCallbackFun, file){
    ...
    var _apiErrorCode;
    try{
        var _jsonObj = JSON.parse(xhr.responseText);
        _apiErrorCode = (_jsonObj != null && typeof _jsonObj.Err != 'undefined') ?　_jsonObj.Err : 0;
    }catch (e) {

    }
    if (!(typeof _apiErrorCode != 'undefined' && _apiErrorCode == 2201)) { // ignore access control
        ...
        if(isErrorCodeJsonFormat){
            ...
            if(file == undefined){
                if(jsonObj != null && apiErrorName != ""){
                    if (apiErrorCode == "1101" && jsonObj.Msg == "A secure password should be set up") {
                        Advantech.Form.WaitingForm.getInstance().hidePleaseWait();
                        var setSecurePasswordDiv = $('<div class="modal fade" id="setSecurePasswordModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="setSecurePasswordTitle" aria-hidden="false">' +
                            '<div class="modal-dialog">' +
                                '<div class="modal-content">' +
                                    '<div class="modal-header">' +
                                        '<h4 class="modal-title" id="setSecurePasswordTitle">Change Root Password</h4>' +
                                    '</div>' +
                                    '<div class="modal-body">' +
                                        '<p>The account is using default password now. To secure the device, you are required to change the password before continuing.</p>' +
                                        '<form role="form">' +
                                    ...
                                    '<div class="modal-footer">' +
                                        '<button type="button" id="btnPw" class="btn btn-success" onclick="setSecurePasswordSubmit()">' +
                        ...
                        '</div><!--/.modal-->' +
                        '<script>' +
                            'function setSecurePasswordSubmit() {' +
                                'var oldPassword = $("#setSecurePasswordModal #inpOldPassword").val();' +
                                'var password = $("#setSecurePasswordModal #inpNewPassword").val();' +
                                'var confirm = $("#setSecurePasswordModal #inpConfirm").val();' +
                                'var length = password.length;' +
                                'if(password === confirm) {' +
                                    'var setSecurePassword = new Advantech.Form.ConfigForm.PasswordChangeModal("setSecurePasswordModal");' +
                                    'var val = setSecurePassword.encapsulatedPassword("H", length, password, oldPassword);' +
                                    'var e = {' +
                                        '"Pw": val' +
                                    '};' +
                                    'httpGetOperation(HTTP_PATCH,' +
                                        ...
                                        'function(){' +
                                            ...
                                            'window.location.href = ABSOLUTE_PATH + "/index.html";' +
                                        '},' +
                                        'function(code, commonMsg, apiErrorCode, apiErrorMsg) {' +
                                            ...
                                            '$("#setSecurePasswordModal").find("#inpNewPassword, #inpConfirm").val("");' +
                                        '},' +
                                        'JSON.stringify(e));' +
                                '}else{' +
                        ...
                        $("body").html(setSecurePasswordDiv);
                        setSecurePasswordDiv.modal({
                            show: true,
                            keyboard: false
                        });
                    } else if (apiErrorCode == "1101" && jsonObj.Msg == "It is necessary to use the root account to set up the password") {
                        Advantech.Form.WaitingForm.getInstance().hidePleaseWait();
                        Advantech.Utility.serverErrorPage("403", jsonObj.Msg);
                    } else {
                        resErrorCallbackFun(status, msg, apiErrorCode, jsonObj.Msg, apiErrorName);
                    }
                }else{
...
$.extend(true, Advantech, {
    Profile:{
        DeviceEmun: {
            "WISE-4210-AP": {
                description: "LPWAN Wireless to Ethernet AP",
/*                ao_Ch: 0,
                ai_Ch: 0,
                di_Ch: 0,
                do_Ch: 0,
                ...
                fwVersion: 'A1.05 B00' // AP use Ethernet FW Version
            },
            "WISE-4210-Default": {
                description: "LPWAN WSN with 4-ch AI and 4-ch DI",
                ao_Ch: 0,
                ai_Ch: 4,
                di_Ch: 4,
                do_Ch: 0,
            ...
            "WISE-4210-S100":{
                description: "Stack Light Sensor",
                ao_Ch: 0,
                ai_Ch: 0,
                di_Ch: 0,
                do_Ch: 0,
                aiRangeEmun:Advantech.Profile.AIRangeEmun,
                aiSamplingSpeedEmun:Advantech.Profile.AISamplingSpeedEmun,
                aiFilterSupport:true,
                aiPhysicalValueSupport: true,
                isSupportAIBurnout:true,
            ...
            /*
            "WISE-4210-S215": {
                description: "LPWAN WSN with 4-ch RTD or Digital Input",
                ao_Ch: 0,
                ai_Ch: 4,
                di_Ch: 4,
                do_Ch: 0,
                ...
                aoDataModuleFactory:function(){null;},
                aiDataModuleFactory:function(){return Advantech.Data.IOData.AITypeDataFactory;},
                diDataModuleFactory:function(){return Advantech.Data.IOData.DITypeDataFactory;}, //UIO
                AiStatusEgLimitPrecision: 4,
                isErrorCodeJsonFormat: true,
                isAccessControlOnlySupportIP: true,
                isSupportUniversalInput: true,
                isSupportRS485: false
            },
            "WISE-4210-S217": {
                description: "LPWAN WSN with 8-ch Analog Input",
                ao_Ch: 0,
                ai_Ch: 8,
                di_Ch: 0,
                do_Ch: 0,
            ...
            */
            "WISE-4210-S231": {
                description: "LPWAN WSN with Temperature/Humidity Sensors",
                ao_Ch: 0,
                ai_Ch: 0,
                di_Ch: 0,
                do_Ch: 0,
            ...
            "WISE-4210-S235":{
                ...
                isSupportSensor: false,
                isDiFilterSupport01msInPowerSaveMode: true,
                isSupportStackLight: false,
                isAdapterBoard: true,
                fwVersion: 'A1.04 B00'
            },
            "WISE-4210-S250": {
                description: "LPWAN WSN with 1-port RS-485 and DIO",
                ao_Ch: 0,
                ai_Ch: 0,
                di_Ch: 6,
                do_Ch: 2,
            ...
            "WISE-4210-S414": {
                description: "LPWAN WSN with 4-ch AI",
                ao_Ch: 0,
                ai_Ch: 4,
                di_Ch: 0,
                do_Ch: 0,
            ...
            "WISE-4210-S472": {
                description: "LPWAN WSN with 2-port RS-485 and 1-ch DI",
                ao_Ch: 0,
                ai_Ch: 0,
                di_Ch: 1,
                do_Ch: 0,
...
*/
            ...
            this.setValue = function(jsonObj,  CfgObj) {
                ...
                if(typeof jsonObj.Fq != "undefined" && typeof CfgObj.FqP != "undefined")
                    this.mFreqLedNumHandler.value(jsonObj.Fq * ((CfgObj.FqP == 1) ? 0.01 : 0.1));
                else
                    this.mFreqLedNumHandler.value(jsonObj.Fq * 0.01);
        ...
        SliderSwitch: function() {
            ...
            this.setValueByAdvJson = function(valObj) {
                if(valObj.Md == 1) {
                    ...
                    var status = (parseInt(valObj.Val, 10) !== 0) ? true : false;
                ...
                if(valObj.Md == 1) {
                    if(valObj.PsCtn == 0) {
                        if(parseInt(valObj.Val, 10) != 0) {
                            if($("#" + _Self.mId + " #psStart").not('[disabled=disabled]')) {
                                $("#" + _Self.mId + " #psStart").attr('disabled', 'disabled').addClass("disabled");
                            }
...
/*                         _Self.mChartHandler.y2Axis.tickFormat(function(d) {
    ...
    Utility: {
        ...
        */
        ...
        restartPage: function(ip, callBackFun) {
        ...
        isOldFwVersion: function (fwVersion){
            var newFwVersion = 102;
            try{
                var arr = fwVersion.split(" ");
                var verNumber = parseFloat(arr[0].replace("A", "")) * 100;

                if(verNumber >= newFwVersion)
                    return false;
                else
                    return true;
            }catch(err){
                ...
                var updateProgressForm = function(progress /*0~100*/ ) {
                    ...
                    (function loop(){
                        ...
                        if(barVal < currProgress && progress < 100) //If progress is 0~99, update progress bar
                            TimerID = setTimeout(loop, 500);    //Total upload time is about 58 sec
        ...
        IOForm: {
            IOConfigController:function(baseForm, overviewTable, module, profile) {
                ...
                this.updateUI = function(){
                    Advantech.Privilege.UIManagerSingleton.getInstance().refreshUI();
                    if(Advantech.Profile.VCOM_CONNECTION){ //Node
                            ...
                            for (var i = 0; i < _Self.getModule().getLength()-1; ++i) {
                                ...
                                if(rowData.length > 0){ //hide UDI channels
                                    ...
                                    if(i == mAvgChannelIndex){
                                        if(typeof obj.Rng != 'undefined'){
                                            delete obj["Rng"];
                                        }
                                        if(typeof obj.En != 'undefined'){
                                            delete obj["En"];
                                        }
                                    }
                                    AICfg.push(obj);
...
///
            ...
            AIPlugInAIConfigForm:function(formId){
                ...
                this.initialForm = function(containerName) {
                    ...
                    $configForm.find("#physicalMappingUnit").hide();//for WISE-4210
...
*/
            ...
            DOPlugInDOConfigForm: function(formId) {
                ...
                this.initialForm = function(containerName) {
                    var configForm = document.createElement('div');
                    configForm.id = this.getFormId();
                    configForm.innerHTML = "<div class='form-group isModuleInternalOnly' style='display: none;'>" + // FSV hidden according to Firmware
            ...
            IOConfigBaseForm: function(formId){
                ...
                this.toJson = function() {
                    ...
                    obj['FSV'] = $("#" + _Self.getFormId() + " #inpFSV").prop('checked') ? 1 : 0; // FSV hidden according to Firmware
                    return obj;
                };
                ...
                var setMode = function(containerName, mdArray) {
                    if($.isArray(mdArray)) {
                        ...
                        for(var i = 0; i < mdArray.length; ++i){
                            ...
                            //Robert(2017/11/09): no DI disable mode Array
            ...
            AIStatusPage: function(pageId, channelNumber) {
                ...
                this.createPage = function(containerName, profile) {
                    ...
                    try{
                        ...
                        if(!Advantech.Profile.VCOM_CONNECTION){
                            $('#' + _Self.getPageId() + ' #AIConfigTab').hide();
                        }
                ...
                this.setupPage = function(profile) {
                    var module = Advantech.Utility.RecordContextPageIdSingleton.getInstance().GetCurrentModule();
                    var deviceObj = Advantech.Profile.DeviceEmun[module];
                    // var configDataModule = deviceObj.aiDataModuleFactory.apply(this,[]);
                    var configDataModule = Advantech.Data.IOData.AITypeDataFactory;
                    if(configDataModule == null){
                        throw new Error("Parameter setup failure. Please implement device emun aiDataModuleFactory");
                    }
                    var rngEmun = deviceObj["aiRangeEmun"]||Advantech.Profile.WISE_4012_RangeEmun;
                ...
                this.setValues = function(valuessJson, isInitial) {
                    ...
                    if(valuesArray) {
                        ...
                        var _tableLength = Advantech.Profile.VCOM_CONNECTION ? valuesArray.length : avgCh;
            ...
            DIStatusPage: function(pageId, channelNumber) {
                ...
                this.createPage = function(containerName, profile) {
                    ...
                    try{
                        var element = document.getElementById(containerName).appendChild(diPageContainer);
                        if(!Advantech.Profile.VCOM_CONNECTION){
                            $('#' + _Self.getPageId() + ' #DIConfigTab').hide();
                        }
                        this.setupPage(profile);
                        this.handleEvent();
                    }catch(e){
                ...
                this.setupPage = function(profile) {
                    /* var deviceObj = Advantech.Profile.DeviceEmun[profile.Id];
                    if(!Advantech.Profile.VCOM_CONNECTION){ //AP
                        deviceObj = Advantech.Data.IOData.DITypeDataFactory;
                    }else{//Node
                        deviceObj = Advantech.Profile.DeviceEmun[profile.Id];
                    }
                    var configDataModule = deviceObj.diDataModuleFactory.apply(this,[]); */
                    var configDataModule = Advantech.Data.IOData.DITypeDataFactory;//.apply(this,[]);
                    if(configDataModule == null){
                        throw new Error("Parameter setup failure. Please implement device emun diDataModuleFactory");
                    }
                    var mdEmun = Advantech.Profile.DIModeTypeEmun; //deviceObj.diModeEmun;
                ...
                this.setValues = function(valuessJson, isInitial) {
                    try{
                        ...
                        if (!Advantech.Profile.VCOM_CONNECTION) {
                            IOCfg.setConfig(valuessJson.DIVal);
                            var configArray = valuessJson.DIVal;
                            if(isInitial && configArray){
                                _Self.getConfigController().clearData();
                                for (var i = 0; i < configArray.length; ++i) {
                                    _Self.getConfigController().appendData(configArray[i]);
                                    var md = int(configArray[i].Md);
                                    _Self.getCtrlList()[configArray[i].Ch].setDIRemoteStatus(md, 2); // frequency value is multiplied by 100 in WISE-4210-AP, so decimal is 2(0.01Hz)
                                }
                            }
                        }
                        ...
                        if(valuesArray) {
                            ...
                            for (var i = 0; i < valuesArray.length; ++i) {
                                ...
                                if(isInitial === true)
                                    this.updateValueTables(md, idx, valuesArray[i]);
                                else
                                    this.updateRemoteDatas(idx, valuesArray[i]);
            ...
            DOStatusPage: function(pageId, channelNumber) {
                ...
                this.createPage = function(containerName, profile) {
                    ...
                    try{
                        ...
                        if(!Advantech.Profile.VCOM_CONNECTION){
                            $('#' + _Self.getPageId() + ' #DOConfigTab').hide();
                        }
                        this.setupPage(profile);
                        this.handleEvent();
                    }catch(e){
                ...
                this.updateValueTables = function(mode, channel, valueJson) {
                    ...
                    var value = (parseInt(valueJson.Val, 10) !== 0) ? true : false;
                    var valuePulse = 0;
                    if(iMode === 1) {
                ...
                this.setupPage = function(profile) {
                    ...
                    var configDataModule = Advantech.Data.IOData.DOTypeDataFactory;
                    if(configDataModule == null){
                        throw new Error("Parameter setup failure. Please implement device emun doDataModuleFactory");
                    }
                    var mdEmun = Advantech.Profile.DOModeTypeEmun;//deviceObj.doModeEmun;
                    _Self.setModeRangeEmun(mdEmun);
                    if(configDataModule == null){
                ...
                this.setValues = function(valuesJson, isInitial) {
                    try{
                        ...
                        if (!Advantech.Profile.VCOM_CONNECTION) {
                            var configArray = valuesJson.DOVal;
                            if(configArray){
                                _Self.getConfigController().clearData();
                                for (var i = 0; i < configArray.length; ++i) {
                                    _Self.getConfigController().appendData(configArray[i]);
...
*/
            ...
            IOStatusTab: function(tabId) {
                ...
                this.CreateIOPage = function(profileArray, slotIndex) {
                    ...
                    if(soltProfile == null){
                        ...
                        if(Advantech.Profile.DeviceEmun[currentModule] == undefined && Advantech.Profile.VCOM_CONNECTION){
                            ...
                            var uiFlag, rs485Flag, sensorFlag, stackLightFlag;
                            var uiChannelAmount = 0;

                            if(Advantech.Profile.VCOM_CONNECTION){
                                uiFlag = Advantech.Profile.DeviceEmun[currentModule].isSupportUniversalInput;
                                rs485Flag = Advantech.Profile.DeviceEmun[currentModule].isSupportRS485;
                                sensorFlag = Advantech.Profile.DeviceEmun[currentModule].isSupportSensor;
                                stackLightFlag = Advantech.Profile.DeviceEmun[currentModule].isSupportStackLight;
                            }else{
                                //AP: Downlink mode may not have module name
                                Advantech.Utility.RecordContextPageIdSingleton.getInstance().SetCurrentModule('WISE-4210-Default');
                                uiFlag = (soltProfile.UIn > 0) ? true : false;
                                rs485Flag = (soltProfile.RT > 0) ? true : false;
                                sensorFlag = (soltProfile.Sn > 0) ? true : false;
                                stackLightFlag = (soltProfile.LSChM > 0) ? true : false;
                            }
                            ...
                            if(typeof(stackLightFlag)!='undefined' && stackLightFlag){
                                this.AppendTab("TabStackLight", "Stack Light");
                            }
        ...
        ConfigForm: {
            CloudConfigPanel:function(panelId){
                ...
                var mIftttPanelId = null;
                var mAwsPanelId = null;
                ...
                this.setOtherPanelId = function(privateServerPanelId, webAccessPanelId, aliyunPanelId, azurePanelId, mqttPanelId, iftttPanelId, awsPanelId){
                    ...
                    mIftttPanelId = iftttPanelId;
                    mAwsPanelId = awsPanelId;
                }
                ...
                this.refreshPanelData = function(jsonObj){
                ...
                /*var getCloudStatusValue = function(readyMask, selectMask){
                    ...
                    $selCloud.change(function(){
                        ...
                        if(index == Advantech.Profile.CloudServiceSelectIndex.PrivateServer){
                            ...
                            if(mWebAccessPanelId != null) {
                                mWebAccessPanelId.refreshStatus()();
                            }
                        ...
                        }else if(index == Advantech.Profile.CloudServiceSelectIndex.IFTTT){
                            _$Panel.find(".cloudPanel").hide();
                            _$Panel.find("#panelIFTTT").show();
                            //get IFTTT setting
                            if(mIftttPanelId != null) {
                                mIftttPanelId.refreshStatus()();
                            }
            ...
            IftttConfigPanel: function(panelId) {
                var _onIftttConfigSubmitted = null;
                var _refreshStatus = null;
                var mContextContainerId = panelId;
                var _Self = this;
                this.getPanelId = function() {
                ...
                var handleSubmitted = function(){
                    $("#" + _Self.getPanelId() + " #btnIFTTTSubmit").click(function() {
                        if($.isFunction(_Self.onIftttConfigSubmitted())) {
                            _Self.onIftttConfigSubmitted().apply(this, [this, _Self.toJson()]);
                        }
                    });
                };
                this.setPanel = function(jsonObj) {
                    try{
                        $("#"+_Self.getPanelId()+" #logEvt" ).val(jsonObj.Evt);
                ...
                this.onIftttConfigSubmitted = function(x) {
                    if(!arguments.length) return _onIftttConfigSubmitted;
                    _onIftttConfigSubmitted = x;
                };
            },
            ...
            MqttConfigPanel: function(panelId) {
                ...
                this.initialPanel = function() {
                    handleFileUpload();
                    handleSubmitted();
                    handleWsPath();//Handle WebSocket Path
                ...
                this.setPanel = function(jsonObj) {
                    try{
                        ...
                        //Handle WebSocket Path enable/disable
            ...
            PasswordChangeModal: function(modalId) {
                ...
                this.initialModal = function() {
                    ...
                    $('#' + _Self.getModalId()).on('show.bs.modal', function(event) {
                        ...
                        modal.find('#btnPw').bind("click", function() {
                            ...
                            var length = password.length;
                            if(password === confirm) {
                                var val = _Self.encapsulatedPassword(userCode, length, password, oldPassword);
                ...
                this.encapsulatedPassword = function(userCode, length, password, oldPassword) {
                    var s = [],
                        r = "";
...
/*                this.onGroupConfigDownloadSubmitted = function(x) {
            ...
            ModbusAddressConfigPanel: function(panelId, tagName) {
                ...
                this.initialPanel = function(containerId) {
                    ...
                    var modbusTag = containerId == 'modbusCoilContext' ? Advantech.Profile.ModbusCoilTagEmun : Advantech.Profile.ModbusRegisterTagEmun;
                    ...
                    modbusAddrConfigContainer.innerHTML = "<div class='panel panel-default'>" +
                        "<div class='panel-heading'>" +
                        "<h4>" + modbusTag[this.getTagName()] + "</h4>" +
                        "</div>" +
            ...
            ModbusAddressCommonConfigTable: function(tableId) {
                ...
                this.addRow = function(tagName) {
                    ...
                    mLength++;
                    var row = document.createElement('tr');
                    var modbusTag = this.getTableId() == 'tableCoilCommonAddr' ? Advantech.Profile.ModbusCoilTagEmun : Advantech.Profile.ModbusRegisterTagEmun;
                    row.id = 'row' + tagName;
                    for (var i = 0; i < 3; ++i) {
                        var cell = row.insertCell(i);
                        if(i == 0) {
                            cell.innerHTML = '<td>' + modbusTag[tagName] + '</td>';
                        }else if(i == 1) {
                            cell.innerHTML = "<input type='number' min='1' max='65535' id ='bas" + tagName + "' value='0' class='form-control isNumericType'>";
                        }else{
            ...
            CouplerInfoPanel: function(panelId) {
                ...
                this.setCouplerWorkingMode = function(jsonObj) {
					if(Advantech.Profile.VCOM_CONNECTION){//End device
						$("#" + _Self.getPanelId() + " #moduleModeDiv").hide();
					}
                    ...
                    $("#" + _Self.getPanelId() + " #inpRfMd").val(Advantech.Profile.Sub1GRfWorkingModeEmun[jsonObj.Md]);
                };
                ...
                this.setSlotInfoPanel = function(index, jsonObj) {
                    try{
                        ...
                        else
                        {
                            ...
                            $("#" + _Self.getPanelId() + " .slotType").show();
                        }
                        $columns[2].innerHTML = getSlotDescription(dev);
                        $columns[3].innerHTML = getFirmwareDescription(dev);
        ...
        AdvancedForm: {
            ...
            DataViewerPanel: function(panelId, tableId, pieContainerId, barContainerId, trendContainerId, panelType) {
                ...
                if(Advantech.Profile.VCOM_CONNECTION){//end node
                    _EventTypeEmun = Advantech.Profile.DataLogNodeEventTypeEmun;
                }
                ...
                var val2RecordEmunString = function(val){
                    if(mPanelType=='system'){
						...
						return _IOTypeEmun[val];//no pe(log type) in sub1G, use io type instead
                    }
                };
                    ...
                    try{
                        if(mPanelType == 'system'){
                            ...
                            if(bInitial){
								...
								$("#"+_Self.getPanelId()+' [data-select="macSlot"]').find('option').remove();
                ...
                this.getFilterObj = function() {
                    ...
                    if(mPanelType == 'io'){
                        fltVal = 0; //no filter for Sub1G IO
                    }
                    obj.Fltr = fltVal;
                    if(fltVal === 0) {
                        return obj;
                ...
                this.setDataTable = function(jsonObj) {
                    try{
                        ...
                        var amountOfEachUnit;
                        var totalDataAmount

                        if(mPanelType=='io'){
                            amountOfEachUnit = (jsonObj.Record.length == 0)?0:Number(jsonObj.Record[0].length);
                            totalDataAmount = jsonObj.Record.length * amountOfEachUnit;
                            if(totalDataAmount > _DATA_DISPLAY_LIMITATION){
    							...
    							mJsonDatas = {};
    							mJsonDatas.TIM = jsonObj.TIM;
    							mJsonDatas.UID = jsonObj.UID;
    							mJsonDatas.MAC = jsonObj.MAC;
    							amountOfFeasible = -amountOfFeasible;
                                mJsonDatas.Record = jsonObj.Record.slice(amountOfFeasible);//last records
                            }else{
                                mJsonDatas = jsonObj;
                            }
                        }else{//system type
                            amountOfEachUnit = (jsonObj.LogMsg.length < 1)?0:Number(jsonObj.LogMsg[0].Record.length);
                            totalDataAmount = jsonObj.LogMsg.length*amountOfEachUnit;
                            if(totalDataAmount > _DATA_DISPLAY_LIMITATION){
                                var amountOfFeasible = Math.ceil(_DATA_DISPLAY_LIMITATION/(amountOfEachUnit*(1.0)));
                                Advantech.Form.MessageForm.getInstance().showMessageBox("Notification","<h5>Only latest "+amountOfFeasible+" records are provided for manipulation, due to browser resource limitation.</h5>");
						...
						if(typeof(jsonObj)!= 'undefined'){
                            if(_worker != null){
                                ...
                                if(mPanelType=='system'){//system
                                    logMsg = jsonObj["LogMsg"];
                                    ...
                                    logMsg = jsonObj;
                                    var pe = 0;//logMsg[i].PE;//for Sub1G
                                    var tim = logMsg.TIM || "****";//logMsg[i].TIM || "****";
                                    var uid = logMsg.UID || "****";//logMsg[i].UID || "****";
                                    var mac = logMsg.MAC || "****";//logMsg[i].MAC || "****";
                                    var utc = getUTCTime(logMsg.TIM);//getUTCTime(logMsg[i].TIM);
                                    /*if(mPanelType=='system'){
                                        var record = logMsg.Record || "****";//logMsg[i].Record || "****";
                                        rawData.push(toSystemRawData(pe, tim, uid, mac, record));
                                    }else{*/
                                        var recordArray = logMsg.Record;//logMsg[i].Record;
                                        for (var j = 0; j < recordArray.length; ++j) {
                                            rawData.push(toRawData(pe, tim, uid, mac, recordArray[j]));
                                        }
                                }
                ...
                this.initialPanel = function() {
                    ...
                    $('[data-select="slot"]').change(function(){
						if(mPanelType!='system'){
							...
							if(panelType != 'system' && __worker != null){
								$("#" + _Self.getPanelId() + " .dataType").hide();
								$("#" + _Self.getPanelId() + " .processingType").show();
...
/*                this.onDataLogSensorOptionSubmitted = function(x) {
            ...
            DataLogLoggerConfigPanel: function(panelId) {
				...
				var _onRfLogStatusChanged = null;
...
/*                     $("#" + _Self.getPanelId() + " #memDEn").click(function() {
					...
					/* $("#" + _Self.getPanelId() + " #cloudREn").click(function() {//RF log
                        if($.isFunction(_Self.onRfLogStatusChanged())) {
                            var status = $(this).prop("checked")?1:0;
                            _Self.onRfLogStatusChanged().apply(this, [this, {REn:status}]);
                        }
                    }); */
                    /*
...
/*                     $("#" + _Self.getPanelId() + " #pushDEn").click(function() {
                ...
                this.setPanel = function(logSwitchJson, logUploadJson, pushOutputJson) {
                    try{
                        ...
                        if(logUploadJson != null){
							...
							//$("#"+_Self.getPanelId()+" #cloudREn").prop("checked", int(logUploadJson.REn) !== 0 ? true : false);
                            ...
                            $("#"+_Self.getPanelId()+" #selREn" ).val(logUploadJson.REn).trigger("change");
                            $("#"+_Self.getPanelId()+" #inpRTim").val(logUploadJson.RTim);
                            $("#"+_Self.getPanelId()+" #inpRItm").val(logUploadJson.RItm);
                        }
                        if(pushOutputJson != null){
                            ...
                            if(int(pushOutputJson.REn) == 0 && int(pushOutputJson.SEn) ==0)
                                $("#" + _Self.getPanelId() + " #pushNotifySetting").hide();
                            else
                                $("#" + _Self.getPanelId() + " #pushNotifySetting").show();
                        }
				...
				this.onRfLogStatusChanged = function(x) {
                    if(!arguments.length) return _onRfLogStatusChanged;
                    _onRfLogStatusChanged = x;
                };
            ...
            DataLogSettingPanel: function(panelId){
                var _onDataLogSettingSubmitted = null;
                var mContextContainerId = panelId;
                var _Self = this;
                this.getPanelId = function() {
                    return mContextContainerId;
                ...
                this.setPanel = function(jsonObj) {
                    try{
                        ...
                        $("#" + _Self.getPanelId() + " #inpCh").prop("checked", (int(jsonObj.Ch) ==1)?true:false);
                    }catch(e){
                        throw new Error("Data log setting parameter failed.")
                    }
                };
                this.toJson = function() {
                    var jsonObj = {};
                ...
                this.onDataLogSettingSubmitted = function(x) {
                    if(!arguments.length) return _onDataLogSettingSubmitted;
                    _onDataLogSettingSubmitted = x;
                };
            },
            ...
            DataLogChannelMaskPanel: function(panelId, slotNumber) {
                ...
                this.initialPanel = function(profileArray) {
                    ...
                    for (var i = 0; i < _Self.getSlotNumber(); ++i) {//check all slots
                        if(i < profileLength) {
                            var slot = profileArray.Dev[i].SLs;
            ...
            AccessCrtlTable: function(tableId, ctrlNumber) {
                ...
                this.initialTable = function() {
                    try {
                        if (Advantech.Data.ModuleData.getInstance().getRfMode() === 1) {
                            $('#accessCtrlForm a[href="#tabNodeAccessCtrl"]').hide();
                        }
                        setupTable();
